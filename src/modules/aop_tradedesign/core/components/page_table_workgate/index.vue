      ...
      >
        ...
        >
          ...
          <span
            ...
            class="text_style"
            :class="item.textClass ? typeof item.textClass == 'string' ? item.textClass : item.textClass(scope, item) : ''"
            @click="operate(item.operate, scope.row)"
          >
            {{ getFilters(scope, item) }}
          </span>
          <span
            v-else-if="item.type == 'imageShow'"
          >
...
export default {
  ...
  methods: {
    ...
    getButtonList(item, scope) {
      return typeof item.buttonList == 'object' ? item.buttonList : item.buttonList(scope.row)
    }
  },
  created() {},
  mounted() {},
