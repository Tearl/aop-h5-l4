  ...
  <div class="aop_workgate_comps_page_big_data">
    ...
    >
      <el-row v-if="type == ''" class="grid_no_re">
        ...
        <el-col :span="4"><div class="grid_header">参数名称</div></el-col>
        ...
        <el-col :span="3"><div class="grid_header">参数描述</div></el-col>
        ...
        <div class="grid_item" v-for="(item, index) in data" :key="index">
          ...
          <el-col :span="3"
            ><div class="grid_content">
              ...
              >
                <el-option
                  v-for="(nItem, nI) in typeList"
                  :value="nItem.value"
                  :key="nI"
                  :label="nItem.type"
                  :disabled="getOptionsDisabled('paramValueType', item, nItem)"
          ...
          <el-col :span="2"
            ><div class="grid_content">
              <el-input
                ...
                :disabled="item.disabled || item.lengthDisabled"
                size="small"
                clearable
                placeholder=""
                maxlength="50"
...
export default {
  ...
  methods: {
    ...
    handleValueType(e) {
      ...
      if(e.paramKey && ["List","Object"].includes(e.paramValueType)){
    ...
    getOptionsDisabled(key, item, option) {
      if (key == "paramValueType") {
        // 当参数的类型为复杂数据类型且存在子参数的情况下，不能修改为简单数据类型
        return this.complexDataType.includes(item.paramValueType) && item?.children?.length && !this.complexDataType.includes(option.value)
      }
    }
  },
  mounted() {
