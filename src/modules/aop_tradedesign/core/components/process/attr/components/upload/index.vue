<template>
  <div class="aop_tradedesign_comps_design_attr_upload_attr">
    <div class="attr_main">
      ...
      <div v-if="!isRead" class="attr_box">
        <div class="attr_show">
          ...
          <div class="attr_show_item">
            ...
            <div class="attr_show_item_c">
              <el-input disabled v-model="formData.uploadKey" size="mini"></el-input>
            </div>
          </div>
          <!-- <div class="attr_show_item">
...
export default {
  ...
  methods: {
    async getParams(e, obj) {
      this.currentObj = e
      if (e.compositeId && e.paramList?.length) {
        const params = {
          d4StusCd: "1",
      ...
      //     param.actionId = param.actionId || this.transId
      //     return true
      //   }
      // })
...
.aop_tradedesign_comps_design_attr_upload_attr {
  display: flex;
