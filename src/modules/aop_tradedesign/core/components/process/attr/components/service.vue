<template>
  <div class="aop_tradedesign_comps_design_attr_service">
    <div class="attr_main">
  ...
  methods: {
    ...
    async getServiceCpnParams(e) {
      ...
      if (e.compositeId) {
        ...
        //   return item
        // })
        const ruleInfo = await this.rpc.d4.queryL5ParamAndRuleDefinitions(params)
...
.aop_tradedesign_comps_design_attr_service {
  display: flex;
