<template>
  <div class="aop_tradedesign_comps_design_attr_transaction">
    <div class="attr_main">
      <div class="attr_tabs">
              ...
              <div class="icon">
                <span
                  ...
                  :class="{
                    ...
                    blue: ['inputAction', 'outputAction', 'loopAction', 'containerAction', 'cacheSessionAction', 'getSessionAction', 'createGraphValidateCodeAction', 'verifyGraphValidateCodeAction', 'getCacheAction', 'setCacheAction'].includes(item.actionType),
...
.aop_tradedesign_comps_design_attr_transaction {
  display: flex;
