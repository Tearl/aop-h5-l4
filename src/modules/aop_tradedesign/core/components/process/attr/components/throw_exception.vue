<template>
  <div class="aop_tradedesign_comps_design_attr_throw_exception_attr">
    <div class="attr_main">
      ...
      <div class="attr_box">
        <div class="attr_show">
          ...
          <div class="attr_show_item">
            <div class="attr_show_item_t">错误码：<span v-if="isRead" class="attr_show_item_i">{{formData.errorCode}}</span></div>
            <div class="attr_show_item_c" v-if="!isRead">
              <el-input :disabled="isRead" v-model="formData.errorCode" size="mini"></el-input>
            </div>
          </div>
          <div class="attr_show_item">
            <div class="attr_show_item_t">错误信息：<span v-if="isRead" class="attr_show_item_i">{{formData.errorMsg}}</span></div>
            <div class="attr_show_item_c" v-if="!isRead">
              <el-input
                :disabled="isRead"
                type="textarea"
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      // this.tableData = reList(this.currentServObj.puApiParams.filter((item) => item.paramDirection == 1));
    }
  },
  created() {
    this.init()
...
.aop_tradedesign_comps_design_attr_throw_exception_attr {
  position: relative;
  height: 100%;
  .attr_main {
    height: 100%;
