        ...
        <div class="add_obj_behavior_box">
            ...
            <div class="base_info_box" id="applyHandleBox">
                ...
                <div class="table_box approve_table_box">
                    <!-- confim 抛出修改的对象 -->
                    <editObject ref="editObject" :activeName="'tab2'" :objId="editId" @confim="confim" :viewData="detailData"
                        :addAttr="true" :look="true" />
                </div>
            </div>
            <div class="footer_btn">
                <div class="btn_box">
                    <el-button @click="routeBack" size="small" plain>关闭</el-button>
...
export default {
    ...
    methods: {
        ...
        saveForm(val) {
            ...
            const obaReplaceInfo = Object.entries(mappings.attribute).map(([originalId, values]) => ({
                originalId: originalId,
                replaceId: values[0] || ""
            }));
            const obeReplaceInfo = Object.entries(mappings.behavior).map(([originalId, values]) => ({
                originalId: originalId,
                replaceId: values[0] || ""
            }));
            let parmas = {
                ...
                // updateApprovalObeInfo: basicInfo.objectBehaviorInfos, //对象行为信息-原
                // updateApprovalObeInfoNew: selectedItem.objectBehaviorInfos, //对象行为信息-新
                updateApprovalObjectInfo: {
                    ...basicInfo,
                    obaReplaceInfo,
                    obeReplaceInfo
                }, //对象信息-原
                updateApprovalObjectInfoNew: selectedItem, //对象信息-新
