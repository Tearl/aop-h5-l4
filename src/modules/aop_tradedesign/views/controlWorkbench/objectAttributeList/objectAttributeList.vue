    ...
    <div class="object_list_box">
        <div class="search" v-show="isSearch" ref="searchRefs">
            <div class="form">
                <el-form size="small" :model="formData" inline="true" ref="form">
                    <el-form-item label="对象属性名称：" label-width="110px">
        ...
        <div class="table_box">
            ...
            <el-table :data="tableData" v-loading="tableLoading" :stripe="isStripe">
                <el-table-column prop="fileNameStr" label="对象属性" min-width="230">
                    <template slot-scope="scope">
                        <!-- <span>{{ scope.row.fileNameStr || "/" }}</span> -->
                          <span v-html="scope.row.fileNameStr || '—'"></span>
                    </template>
                </el-table-column>
    ...
    methods: {
        ...
        handleClick(row, type) {
            if (type == 'approve') {
                // 审批
                this.$router.push({
                    path: '/aop_tradedesign/controlWorkbench/addObjectAttribute',
                    query: {
                ...
                // 查看
                this.$router.push({
                    path: '/aop_tradedesign/controlWorkbench/lookObjectAttribute',
                    query: {
                        listType: this.listType,
                        sideType: this.sideType,
                        aplySrlNo: row.aplySrlNo,
