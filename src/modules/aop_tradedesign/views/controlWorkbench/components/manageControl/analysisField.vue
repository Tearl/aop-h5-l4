        ...
        <div class="drawer-main-content info-form-content">
          ...
          <div class="aop-com-info-form-wrap">
                ...
                <el-col :span="24">
                  <el-form-item label="字段名称" prop="fieldName">
                    <el-input
                      ...
                      placeholder="请输入字段名称，用可空号隔开进行评估分析"
                      :maxlength="20"
                      :disabled="initData.fieldNameDisabled"
                    >
                      <el-button
                        slot="append"
                        type="primary"
            ...
            <div class="padding-b-12">
              <el-button
                @click="handleAddWordRoots"
                class="com-primary-medium-btn"
                icon="el-icon-plus"
                type="primary"
                size="small"
                >新增词根</el-button
                ...
                >
                  <template slot-scope="scope">
                    <el-radio
                      ...
                      :label="scope.row.rootIdCombine"
                      >&nbsp;</el-radio
                    >
                  </template>
                </el-table-column>
                <el-table-column
                  prop="rootShortNameCombine"
                  label="推荐名称"
                  min-width="100"
                ></el-table-column>

                <el-table-column
                  v-for="index in maxRootCount"
                  :prop="'rootName_' + (index - 1)"
                  :label="'词根' + index"
                  :key="index"
                  min-width="120"
                >
