    ...
    <el-drawer :title="title" :visible.sync="value" class="workspace_common_drawer" direction="rtl"
      ...
      <div class="edit_object">
        ...
        <div class="demo-drawer__content" v-show="activeName == 'tab4'">
              ...
              <div style="flex: 1;overflow-x: hidden; border-left: 1px solid #e5e5e5;">
                <div class="content_list">
                  ...
                  <template v-if="handelType == '0'">
                    ...
                    <el-table :data="behaviorList" key="behaviorTable">
                  ...
                  <template v-if="handelType == '1' && (showForm || sideTabList.length > 0)">
                    <el-form ref="behaviorForm" :model="form" label-width="120px" :rules="behaviorRules">
                      ...
                      <el-form-item label="行为名称：" prop="obeName">
                        <el-input class="input" v-model="form.obeName" :disabled="!isEdit" @input="inputChangeFn"
                          clearable placeholder="请输入行为名称">
                        </el-input>
                      </el-form-item>
                    ...
                    <el-row style="display: flex;align-items: center;margin-bottom: 20px;" v-if="showDetail">
                      <div style="margin-right: 8px;"><span style="color: #F56C6C; margin-right: 4px;">*</span>选择S6服务
                      </div>
          ...
          <!-- 添加对象关系弹窗 -->
          <el-dialog width="60%" :title="relationTitle" :visible.sync="dialogVisibleRelation"
            :close-on-click-modal="false" class="inner_cheetah_common_dialog">
            <div class="relationObjMain">
              ...
              <div class="relationObjMain-select">
                ...
                <div class="relationObjMain-select-content">
                  <label>目标对象</label>
                  <el-select v-model="relationshipObj" filterable remote placeholder="请选择目标对象"
                    :remote-method="remoteMethod" :loading="loading" size="small" style="width: 140px">
      ...
      if (this.sideTabList.length > 0) {
        ...
        if (this.form.approvalStatus !== '01') {
          ...
          if (this.handelType == '0') {
            this.obeId = this.sideTabList[0].selectedObeId
          }
        }
      }
      if (res.l5ObjId) {
