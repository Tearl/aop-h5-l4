    ...
    <el-dialog class="aop_tradedesign_comps_page_dialog" title="对比" :visible.sync="dialogVisiable" :width="dialogWidth"
            ...
            <div class="box_center">
                <div class="box_r box_wrap">
                    ...
                    <div class="info_card">
                        ...
                        <div class="info_t">
                            <div class="left_b">
                                更新人：{{ selectInfo.createUserName || '/' }}
                            </div>
                            <div class="right_b">
                                更新时间：{{ selectInfo.createTime || '/' }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box_bottom enum_box">
                    <el-table :data="dataDictionaryEnumLists" :header-cell-style="{
                        background: '#f5f5f8',
                        color: '#333333',
                    }">
        ...
        <span slot="footer" class="dialog_footer">
            <slot name="footer">
                ...
                <el-button type="primary" v-if="selectInfo.fieldFlag == '1'" @click.native="useField">升级并使用</el-button>
                <el-button type="primary" v-else @click.native="handleSave">选 中</el-button>
            </slot>
        </span>
    </el-dialog>
</template>
    ...
    methods: {
        handleSave() {
            ...
            this.$emit("saveDialog", {
                ...this.selectInfo,
                dataDictionaryEnumLists: this.dataDictionaryEnumLists,
            });
        },
        useField() {
            // console.log('升级并使用')
           this.$emit("handleView", {...this.selectInfo}, 'useField');
        },
        handleClose() {
            this.dialogVisiable = false
        },
