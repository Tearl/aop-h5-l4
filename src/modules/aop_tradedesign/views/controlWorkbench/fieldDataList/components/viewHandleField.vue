...
<template>
  <div>
    <el-drawer class="aop-com-drawer" :title="drawerTitle" :size="800" :visible.sync="drawerShow"
              ...
              <el-row :gutter="24">
                ...
                <el-col :span="24">
                  <el-form-item label="字段定义：" prop="fieldBusiness">
                    ...
                    <el-input v-model="formData.fieldBusiness" type="textarea" :rows="3" resize="none"
                      placeholder="请输入字段定义" :maxlength="200"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="24">
                ...
                <el-col :span="12">
                  <el-form-item label="主题分类：" prop="standards">
                    <el-cascader placeholder="请选择" v-model="formData.standards" :options="preNodeProps" clearable
                      :props="{
                        lazy: true,
                        lazyLoad,
                        checkStrictly: true,
                ...
                <el-col :span="12">
                  <el-form-item label="长度限制：" prop="fieldLengthLimitType"
                    ...
                    <el-select v-model="formData.fieldLengthLimitType" placeholder="请选择长度限制" @change="changeLength">
                      <el-option v-for="(item, i) in longList" :key="i" :label="item.label"
                        :value="item.value"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="12">
                  ...
                  ">
                    <el-input v-model="formData.fieldLengthMax" placeholder="请输入最大长度，不超过字段长度"
        ...
        if (valid === true) {
          ...
          if (this.action === "reviewField") {
            ...
            this.rpc.controlWorkbench
              .addDataDictionaryItemApplyApproval({
                ...this.formData,
                fieldSource: "common",
                enumCode: this.enumCode,
                fieldId: this.initData.fieldId || "",
              ...
              .then((res) => {
                ...
                //   type: "success",
                // });
                this.$emit("refreshData", res.dataDictionaryFiled);
                this.handleClose();
              })
              .catch(() => { });
          }
