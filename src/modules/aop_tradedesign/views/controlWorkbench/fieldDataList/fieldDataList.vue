    ...
    <div class="object_list_box">
        <div class="search" v-show="isSearch">
            <div class="form">
                <el-form size="small" :model="formData" inline="true" ref="form">
                    ...
                    <el-form-item label="申请人：" prop="createUserName" label-width="110px">
        ...
        <div class="table_box">
            ...
            <el-table :data="tableData" v-loading="tableLoading" :stripe="isStripe">
                <el-table-column prop="fieldName" label="字段名称" min-width="160" show-overflow-tooltip="true">
    ...
    methods: {
        ...
        handleClick(row, type) {
            if (type == 'approve') {
                ...
                // 查看
                this.$router.push({
                    path: '/aop_tradedesign/controlWorkbench/lookFieldData',
                    query: {
                        listType: this.listType,
                        sideType: this.sideType,
                        rowId: row.aplyTargetId,
