...
import Basic from "./form/servInfo";
import Params from "./form/params";
import Rule from "./form/biz_rule";
  ...
  methods: {
    ...
    async getApiDetail(data){
      ...
      obj ={
        ...
        svcNm:res.apiName,
        svcNo:res.apiCode,
        dataSetNm:this.dataObj.dataSetNm || this.dataSetNm,
        svcDesc:res.apiDesc,
