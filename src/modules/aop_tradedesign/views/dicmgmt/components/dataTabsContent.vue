      ...
      <div class="tabsComps">
        ...
        <div class="tabs_content">
          <div class="list">
            ...
            >
              <div class="list_title">
                <span class="title_tabs">分段（{{ susStnCount }}）</span>
                <el-button
                  v-if="fourDesign == 'edit'"
                  type="text"
              ...
              <div class="list_content">
                <div class="search" v-if="searchShow">
                  <el-input size="small" clearable @keyup.enter.native="subSearch" v-model="subNm" placeholder="请输入关键字搜索">
                     <i slot="prefix" class="el-input__icon el-icon-search" @click="subSearch"></i>
                  </el-input>
                </div>
                  ...
                  >
                    <div class="left_content">
                      <div class="left_status">
                        ...
                        > -->
                        <span class="status" :class="getColor(item.statusCd)">{{
                          statusObj[item.statusCd]
                        }}</span>
                        <!-- <span
                          :class="
                    ...
                    <div class="right_content">
                      <div class="operate" v-if="item.statusCd == '0'">
                        <i
                          class="el-icon-view"
            ...
            >
              <div class="list_title">
                <span class="title_tabs">字段（{{ fieldCount }}）</span>
                <el-button
                  v-if="fourDesign == 'edit'"
                  type="text"
                  @click="add('field')"
                  :disabled="susStnCount === 0"
                  icon="el-icon-plus"
                  ></el-button
                >
              </div>
              ...
              <div class="list_content">
                <div class="search"  v-if="searchShow">
                  <el-input size="small" clearable @keyup.enter.native="fieldSearch" v-model="fieldNm" placeholder="请输入关键字搜索">
                     <i slot="prefix" class="el-input__icon el-icon-search" @click="fieldSearch"></i>
                  </el-input>
                </div>
            ...
            >
              <div class="list_title">
                <span class="title_tabs">L5服务（{{ servCount }}）</span>
                <el-button
                  v-if="fourDesign == 'edit'"
                  type="text"
                  @click="add('service')"
              ...
              <div class="list_content">
                <div class="search"  v-if="searchShow">
                  <el-input size="small" clearable @keyup.enter.native="servSearch" v-model="servNm" placeholder="请输入关键字搜索">
                     <i slot="prefix" class="el-input__icon el-icon-search" @click="servSearch"></i>
                  </el-input>
                </div>
                    ...
                    <div class="left_content">
                      <div class="left_status">
                        <!-- <el-tag
                          ...
                          >{{ statusObj[item.statusCd] }}</el-tag
                        > -->
                        <span class="status" :class="getSerColor(item.statusCd)">{{
                          statusSerObj[item.statusCd]
                        }}</span>
                        <!-- <span
                          :class="
                            item.status == '0' ? 'statusRed' : 'statusGreen'
...
export default {
  ...
  methods: {
    ...
    subSearch(){
      this.$emit("subSearch",this.subNm)
    },
    fieldSearch(){
      this.$emit("fieldSearch",this.fieldNm)
    },
    servSearch(){
      this.$emit("servSearch",this.servNm)
    }
  },
};
</script>
