<template>
  <div class="aop_tradedesign_comps_dicmgmt_batch_approve">
    <DictionaryForm
      ref="modRef"
      pageType="appr"
      :apiType="apiType"
...
<script>
import DictionaryForm from "../pub_dic/components/dic_form"
...
export default {
  ...
  methods: {
    toDicList () {
      this.$emit("toDicList", true)
    },
    toDetail () {
      this.$emit("toDetail", false)
    },
    getDetail () {
      this.$refs.modRef.getDictionaryInfoById(this.aplySrlNo)
    },
    //初始化
    init () { },
  },
...
.aop_tradedesign_comps_dicmgmt_batch_approve {
