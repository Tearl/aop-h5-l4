<template>
  <div class="aop_service_comps_d4analyse_process_attr">
    <!-- 服务信息 -->
    ...
    <!-- 需求信息 -->
    <div class="attr_box" v-show="serviceActive == 'demand'">
      ...
      <div class="attr_box">
        <div class="attr_show underLine">
          <div class="attr_show_item flex">
            ...
            <el-select size="mini" v-model="currentR5" placeholder="请选择">
              <el-option
                v-for="item in r5SvcList"
                :key="item.svcId"
                :label="item.svcNm"
                :value="item.svcId"
              >
          ...
          <div class="attr_show_item mb20">
            ...
            <div
              ...
              v-show="inputParamsVisibleAtSetting"
            >
              <Table
                class="table"
                :data="inputParamsListAtSetting"
          ...
          <div class="attr_show_item mb20">
            ...
            <div
              class="attr_show_item_c"
              v-show="outputParamsVisibleAtSetting"
            >
              <Table
                class="table"
                :data="outputParamsListAtSetting"
        ...
        <div class="attr_show underLine">
          ...
          >
            <div class="service_edit_form_info">
              <el-form-item label="4B服务名称" prop="servNm">
                <el-input
                  size="mini"
              ...
              <el-form-item label="4B服务ID" prop="servNo">
                <el-input
                  size="mini"
              ...
              <el-form-item label="4B服务描述" prop="servDescr">
                <el-input
                  size="mini"
                  type="textarea"
                  :rows="4"
    ...
    <div class="attr_main" v-if="showType == 'attr'">
      ...
      <div class="attr_box" v-if="currentObj.actionType == 'inputAction'">
        <div class="attr_send underLine">
          <div class="attr_pre_title">
      ...
      <div class="attr_box">
        <div class="attr_show underLine">
          ...
          <div class="attr_show_item">
            <div class="attr_show_item_t flex">
              ...
              <el-input
                :disabled="isRead"
                class="content"
                v-model="currentLineObj.condition.desc"
                @blur="saveLine(false)"
              ></el-input>
            </div>
          </div>
          <div class="attr_show_item">
            <div class="attr_show_item_t flex">
              <div>条件配置</div>
              <span v-if="!isRead" class="right_btn" @click="showLine"
                >编辑</span
              >
            </div>
            <el-input
              :value="getConditionDesc()"
              type="textarea"
              disabled
              placeholder=""
            ></el-input>
        ...
        <div class="attr_show underLine">
          <div class="attr_show_item flex">
            ...
            <div class="item_value">
              <el-input v-model="ruleItemMsgData.name" size="mini"></el-input>
            </div>
          </div>
          <div class="attr_show_item flex">
      ...
      <div slot="box">
        ...
        >
          <el-form-item label="源错误码" prop="errorCodeFieldName">
            <el-input
              v-model="setErrorMsgform.errorCodeFieldName"
              placeholder="请输入源错误码"
            ></el-input>
          </el-form-item>
          <el-form-item label="映射错误码" prop="errorCodeMappingFieldName">
            <el-input
              v-model="setErrorMsgform.errorCodeMappingFieldName"
              placeholder="请输入映射错误码"
            ></el-input>
          </el-form-item>
          <el-form-item label="映射错误信息" prop="errorMsgFieldName">
            <el-input
              v-model="setErrorMsgform.errorMsgFieldName"
              placeholder="请输入映射错误信息"
            ></el-input>
          </el-form-item>
        </el-form>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      setErrorMsgformRules: {
        errorCodeFieldName: [
          { required: true, message: "请输入源错误码", trigger: "blur" },
        ],
        // errorCodeMappingFieldName: [{ required: true, message: "请输入映射错误码", trigger: "blur" }],
        errorMsgFieldName: [
          { required: true, message: "请输入映射错误信息", trigger: "blur" },
        ],
      },
      // 规则类型选项
      // ruleTypeOptions: [
      ...
      // ],
      ruleTypeOptions: options['ruleType'],
      // 规则组件
      ruleItemMsgData: {
        name: "",
        type: "",
  ...
  computed: {
    ...
    businessRuleColumn() {
      ruleDescType =
        (this.showType == "service" && this.serviceActive == "d4b") ||
        (this.showType == "d4bInfo" && this.d4bActive == "d4b")
          ? "textClick"
          : "text";
      return [
        {
  ...
  methods: {
    ...
    getAttr(e) {
      this.currentObj = e;
      if (e.paramList) {
        this.sData = setSerialNumber(
          array2nested(
            e.paramList.filter((item) => item.paraPosition == "0"),
            "paraPareId",
            "children"
          )
        );
        this.rData = setSerialNumber(
          array2nested(
            e.paramList.filter((item) => item.paraPosition == "1"),
            "paraPareId",
            "children"
          )
        );
        if (
          e.actionType == "executeFlowAction" ||
          e.actionType == "newAction"
        ) {
    ...
    getFlowParams(e) {
      this.currentObj = e;
      this.sData = e.puApiParams.filter((item) => item.paraPosition == "0");
      this.rData = e.puApiParams.filter((item) => item.paraPosition == "1");
    ...
    getConditionDesc() {
      return this.condList.reduce((pre, item, index) => {
        return `${pre}${index != 0 ? this.mtchModeFilter(item.mtchMode) : ""}${
          item.sorcParaNm
        }${item.condTyp}${item.trgtParaNm}`;
      }, "");
    },
...
.aop_service_comps_d4analyse_process_attr {
  position: relative;
  overflow: hidden;
  .attr_main {
    height: 100%;
