<template>
  <div class="aop_tradedesign_comps_apimgmt_api_view_api_flow_serv">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const res = await this.rpc.apimgmt.getServList({apiId: this.apiId})
    ...
    async saveDialog() {
      ...
      const res = await this.rpc.apimgmt.releServ(params)
      this.$notify({
        title: "成功",
        message: "关联成功！",
        duration: 2000,
...
.aop_tradedesign_comps_apimgmt_api_view_api_flow_serv {
