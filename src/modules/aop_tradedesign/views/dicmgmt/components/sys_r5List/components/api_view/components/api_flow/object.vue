<template>
  <div class="aop_tradedesign_comps_apimgmt_api_view_api_flow_object">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const res = await this.rpc.apimgmt.getApiObj(data);
    ...
    async operate(operation, data) {
      if (operation == "delete") {
        this.$confirm("确定要删除吗？").then(async () => {
          ...
          const res = await this.rpc.apimgmt.deleteApiObj(params);
          this.$notify({
            title: "成功",
            message: "删除成功",
            duration: 2000,
        ...
        // this.$router.push({
        //   path: "/aop_tradedesign/dicmgmt/objDetail",
        ...
        // const msgFormat = this.$route.query.msgFormat
        // this.$router.push({
        //   path: "/aop_tradedesign/dicmgmt/modObj",
        //   query: { bsnObjId: data.bsnObjId, sysId: this.sysId, apiId: this.apiId, msgFormat: msgFormat},
        // });
      }
    },
    ...
    async confirm() {
      ...
      const res = await this.rpc.apimgmt.apiRelaObj(params)
      this.$notify({
        title: "成功",
        message: "关联成功！",
        duration: 2000,
...
.aop_tradedesign_comps_apimgmt_api_view_api_flow_object {
