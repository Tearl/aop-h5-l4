<template>
  <div class="aop_tradedesign_comps_apimgmt_api_public_obj_form">
...
import DicSelect from "./dic_select";
import ObjSelect from "./obj_select";
...
export default {
  ...
  methods: {
    ...
    addDicParams() {
      ...
      this.$nextTick(() => {
        this.$refs.dictionaryRef.getList()
      })
    },
    // 数据字典选择弹框取消
    ...
    addBusParams() {
      ...
      this.$nextTick(() => {
        this.$refs.bussinessobjRef.getList()
        this.$refs.bussinessobjRef.getDomainList()
      })
    },
...
.aop_tradedesign_comps_apimgmt_api_public_obj_form {
