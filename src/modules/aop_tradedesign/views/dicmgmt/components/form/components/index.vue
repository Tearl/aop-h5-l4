<template>
  <div class="aop_workgate_comps_dicmgmt_dic_form">
        ...
        >
          <div class="service_create_form_info">
            <el-form-item label="参数名称" prop="dictryNo">
              ...
              <el-button class="" type="primary" @click="showDialog('public')"
    ...
    handleCancel() {
      if(!this.dictryId) {
        if (this.type !== "public") {
          ...
          this.$router.push({
            path: "/aop_workgate/dicmgmt/list",
          });
        }
      } else {
        this.$emit("toDetail");
...
.aop_workgate_comps_dicmgmt_dic_form {
