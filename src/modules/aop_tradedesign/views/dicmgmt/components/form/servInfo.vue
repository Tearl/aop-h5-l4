  ...
  <div class="aop_tradedesign_dic_cmps_data_set_form_serv_Info">
    <el-form ref="formRef" size="small" :model="servForm" :rules="rules" label-width="130px" class="edit_form">
      ...
      <el-form-item label="服务类型：" prop="svcTyp">
        ...
        <!-- <el-input placeholder="请输入服务类型" maxlength="50" disabled v-model="servForm.svcTyp"></el-input> -->
        <!-- <span>自有服务</span> -->
      </el-form-item>
      ...
      <el-form-item label="服务名称：" prop="svcNm">
        <el-input placeholder="请输入服务名称" maxlength="50" v-model.trim="servForm.svcNm"></el-input>
      </el-form-item>
      ...
      <el-form-item label="所属数据集：" v-if="servForm.svcTyp == 'D5自有服务'" prop="dataSetNm">
        <div class="dataSet">
          ...
          <el-button type="primary" class="mt20" size="small" @click.stop="openDataset" v-show="datasetDisabled">选择数据集</el-button>
        </div>
      </el-form-item>
...
export default {
  ...
  watch: {
    servForm() {
      this.datasetDisabled = !this.servForm.dataSetNm

    },
    propData() {
      this.servForm.dataSetNm = this.propData.dataSetNm
      this.datasetDisabled = !this.servForm.dataSetNm
    }
  },
  methods: {
    init() {
      ...
      this.servForm.dataSetNm = this.infoData.dataSetNm
    },
    radioChange(e) {
