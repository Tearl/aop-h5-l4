        ...
        >
          <div class="service_create_form_info">
            ...
            <div v-show="formData.attrType == '0' || chooseRule">
              ...
              <!-- <el-form label-width="120px" :model="formData" :disabled="isDisabled"> -->
              ...
              <!-- <el-form-item
                ...
                formData.dictryTyp == 'Character') && formData.attrType !== '4'
              "
              >
...
export default {
  ...
  computed: {
    ...
    headerTitle() {
      if (this.type === 'addAttr') {
        return '新增属性'
      } else {
        return this.dictryId ? "编辑元数据" : "创建元数据"
      }
    },
    selectTypeList() {
  ...
  methods: {
    ...
    async editDictionary () {
      ...
      console.log(params, "params", this.getParamsRuleIdList(), this.ruleList.length)
      params.beltLine = this.beltLine
      const api =
        this.apiType == "sys"
          ? "modSysDic"
    ...
    handleCancel () {
      if (!this.dictryId) {
        ...
        let type = ''
        if (this.formData.dictryTyp === 'Object') {
          type = '4'
        } else if (this.formData.dictryTyp === 'List') {
          type = '3'
        }
    ...
    init () {
      ...
      this.beltLine = getSessionStorage('beltLine')
