<template>
  <div class="aop_tradedesign_comps_dicmgmt_dic_rule_count">
    <PageDialog
  ...
  methods: {
    ...
    async getList(id) {
      ...
      const { dictList, turnPageTotalNum } =
        await this.rpc.systemmgmt.relevanceDictionaryList(data);
...
.aop_tradedesign_comps_dicmgmt_dic_rule_count {
  .transfer_dialog {
    .dialog_content {
      text-align: center;
      .transfer_form {
