<template>
  <div class="aop_tradedesign_comps_dicmgmt_dialog_selcFromData">
    <PageDialog
      dialogTitle="选择元数据"
    ...
    <AddMateData ref="addMateDataRef"></AddMateData>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    addMateData() {
      this.$refs.addMateDataRef.showDialog();
    },
  },
  created() {
    this.init();
...
.aop_tradedesign_comps_dicmgmt_dialog_selcFromData {
  .content {
    padding: 0px 30px;
  }
