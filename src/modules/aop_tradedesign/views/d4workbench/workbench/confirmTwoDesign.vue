...
import ConfirmTwoDesign from "./components/workbench_design/confirmTwo_define";
export default {
  mixins: [mixin],
  components: {
    ConfirmTwoDesign
  ...
  methods: {
    ...
    init() {
      ...
      // console.log(this.pageMode,this.admiId,this.isolateWorkspace,'this.pageModethis.pageMode')
    },
  },
  created() {
    this.init();
