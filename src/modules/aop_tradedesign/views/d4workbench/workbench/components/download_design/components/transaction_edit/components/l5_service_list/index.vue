<template>
  <div
    class="aop_tradedesign_download_design_transaction_edit_comps_l5_service"
  >
    <div class="flex_tab">
      <div class="content_header base_nav_title table_title">服务列表</div>
...
export default {
  ...
  methods: {
    ...
    handelDetail() {
      this.$router.push({
        path: "/aop_tradedesign/d4workbench/transEdit",
        query: {
    ...
    handelTransDetail() {
      this.$router.push({
        path: "/aop_tradedesign/d4workbench/transDetail",
        query: {
    ...
    handelOneFirm() {
      this.$router.push({
        path: "/aop_tradedesign/d4workbench/transConfirm",
        query: {
...
.aop_tradedesign_download_design_transaction_edit_comps_l5_service {
  .flex_tab {
    display: flex;
