<template>
  <div class="aop_tradedesign_comps_trans_detail_info">
    <div class="content">
      ...
      <div class="detail_list_right">
        ...
        <!-- <div class="right_content">
          <el-checkbox v-model="detailInfo.isSession" disabled
            >是否校验会话</el-checkbox
          >
        </div> -->
      </div>
    ...
    <div class="detail_list_bottom">
      <div class="bottom_content">
        <span>交易描述：</span>
        <span class="content_info">{{ detailInfo.svcDesc }}</span>
      </div>
    </div>
  </div>
</template>
...
.aop_tradedesign_comps_trans_detail_info {
  .content {
    display: flex;
    .detail_list_left,
    .detail_list_right {
