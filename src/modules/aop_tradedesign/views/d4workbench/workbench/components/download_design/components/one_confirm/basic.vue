<template>
  <div class="aop_tradedesign_comps_d4bdesign_info_baisc">
    <div class="content_wrapper">
      <!-- 查看基本信息 -->
      <div :class="type == 'look' ? '' : 'content_read'">
        <div class="detail_content">
          <div class="content_header base_nav_title">基本信息</div>
          <DetailInfo :reqmentId="reqmentId" :detailInfo="detailInfo">
          </DetailInfo>
        </div>
        ...
        <!-- L5服务列表 -->
        <div class="detail_content">
          <L5ServList ref="l5servRef" pageType="confirm"></L5ServList>
        </div>
      </div>
    </div>
...
export default {
  ...
  watch: {
    async basicData(res, o) {
      this.detailInfo = res;
      // this.l5ServiceList = res.d4L5SvcList;
