      ...
      <div class="content_read">
        ...
        <!-- <div class="detail_content">
          ...
          <div class="rules_text">
            <CreateBizRule bizType="read" ref="bizRuleRef"></CreateBizRule>
          </div>
        </div> -->
        <!-- 参数配置 -->
        <div class="detail_content">
...
import { unduplicated, array2NonNested, array2nested, array2flat, unduplicatedByKeys, setSerialNumber } from "@m/utils/array";
...
export default {
  ...
  inject: ["handleGoTo", "toL5ServiceInfo"],
  methods: {
    operate(operation, data) {
      if (operation == "fwmc") {
        this.toL5ServiceInfo(data)
      }
    },
    // 添加mock数据
    addMockData(e) {
    ...
    confirm() {
      this.$refs.form.validate(async (valid) => {
        ...
        params.paramList = unduplicatedByKeys(array2flat(params.paramList), ["paraId", "paraPareId", "paraPosition"]);
        const api =
          this.reuseType == "reuse" || this.pageType == "add" ? "addServiceDemand" : "editServiceCpnDetail";
