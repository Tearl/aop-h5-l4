            ...
            >
              ...
              <div class="list_content">
                <div class="table" v-if="L5serviceList.length > 0">
                  ...
                  >
                    <div class="left_content">
                      <div class="left_title" :title="item.dataSetNm">
                        {{ item.dataSetNm }}
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  data() {
    return {
      ...
      piecewiseList: [
        { id: "3", dataSubstnNm: "基本信息", status: "1" },
        { id: "23", dataSubstnNm: "信用卡信息", status: "0" },
      ],
      fieldList: [
        // { id: "133", dictNm: "账号", status: "1" },
        // { id: "244", dictNm: "密码", status: "0" },
      ],
      L5serviceList: [
        // { id: "551", l5SvcNm: "账户余额查询", status: "1" },
        // { id: "266", l5SvcNm: "账户余额校验", status: "0" },
      ],
      dataStyle: "0", //高亮
      piecewiseStyle: "0",
      fieldStyle: "0",
