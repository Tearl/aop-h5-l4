<template>
  <div class="aop_workgate_comps_systemmgmt_sys_dic_list_transfer">
    <PageDialog
      ref="transferDialog"
      dialogWidth="30%"
      dialogTitle="数据分类切换"
  ...
  methods: {
    ...
    transfer() {
      this.$refs.editForm.validate(async (valid) => {
        ...
        // console.log(params)
        const res = await this.rpc.dictionary.classifyTransfer(params);
        this.$notify({
          title: "成功",
          message: "数据分类切换成功",
          duration: 2000,
...
.aop_workgate_comps_systemmgmt_sys_dic_list_transfer {
  .transfer_dialog {
    .dialog_content {
      text-align: center;
      .transfer_form {
