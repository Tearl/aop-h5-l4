<template>
  <div class="aop_tradedesign_comps_d4design_process_elem">
    <div class="elem_title">
      <span class="bold_text">{{ currentServObj.apiName }}</span>
      <!-- <span @click="showD2InfoDialog">{{ currentServObj.apiName }}</span> -->
      <!-- <el-button
        type="primary"
        size="mini"
        @click="addService"
    ...
    <div class="elem_box">
      ...
      >
        ...
        >
          ...
          <i v-if="!isRead" class="el-icon-plus" @click="addService"></i>
          <!-- <el-tabs v-model="serviceActive" @tab-click="handleTabsClick">
        ...
        <transition name="fade">
          ...
          >
            ...
            ></D5SelfPickList>
            <D5LinkPickList
              v-if="serviceActive == '直连服务'"
              ref="d5LinkPickListRef"
              :currentServObj="currentServObj"
              :servId="servId"
              @showServInfo="showServInfo"
            ></D5LinkPickList> -->
                    ...
                    <div v-if="!['break组件', 'continue组件', '运算组件'].includes(item.cpntNm)" class="icon">
                      <span
                        ...
                        :class="{ 
                          ...
                          grey: ['拼接组件', '文件上传组件'].includes(item.cpntNm),
                        }"
                      ></span>
                    </div>
                    <span class="content">{{
...
.aop_tradedesign_comps_d4design_process_elem {
  // max-width: 240px;
  max-width: 290px;
  user-select: none;
  .elem_title {
