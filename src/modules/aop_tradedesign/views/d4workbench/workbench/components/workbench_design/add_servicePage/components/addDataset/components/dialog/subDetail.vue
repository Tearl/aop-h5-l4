        ...
        <div class="detail_info">
          ...
          <div class="content">
            <div class="detail_list_left">
              ...
              <div class="left_content">
                <span>所属域：</span>
                <span class="content_info">{{ detailInfo.beltLineNm || departmentList[detailInfo.beltLine] }}</span>
              </div>
            </div>
            ...
            <div class="detail_list_middle">
              ...
              <div class="middle_content">
                <span>关系：</span>
                <span class="content_info">{{ dataSubstnAttr[detailInfo.dataSubstnAttr] }}</span>
              </div>
            </div>
