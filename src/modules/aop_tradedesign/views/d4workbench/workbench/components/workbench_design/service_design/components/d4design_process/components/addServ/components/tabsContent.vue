<template>
  <div class="aop_service_dic_comps_tabs_content">
                ...
                <div class="table" v-if="L5serviceList.length > 0">
                  ...
                  >
                    <div class="left_content">
                      ...
                      <div class="left_status">
                        <el-tag
                          :type="item.l5SvcTyp == 'D5自有服务' ? '' : 'warning'"
                          effect="Plain"
                          >{{ L5Obj[item.l5SvcTyp] }}</el-tag
                        >
                        <!-- <span
                          :class="
                            item.status == '0' ? 'statusRed' : 'statusGreen'
...
.aop_service_dic_comps_tabs_content {
  .contentComps {
    // padding: 16px;
    // background: #fff;
    width: 100%;
