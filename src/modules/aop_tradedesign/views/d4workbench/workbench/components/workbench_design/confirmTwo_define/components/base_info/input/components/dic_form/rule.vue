<template>
  <div class="aop_workgate_comps_systemmgmt_dic_form_rule">
    <div class="input_wrapper">
      <div class="top_right_create" v-if="bizType == 'edit'">
        <el-button type="primary" icon="el-icon-plus" @click="showDialog('rule')"
          >配置验证规则</el-button
        >
...
export default {
  ...
  methods: {
    ...
    async getRuleClassification() {
      const res = await this.rpc.dictionary.getRuleClassification();
...
.aop_workgate_comps_systemmgmt_dic_form_rule {
  .top_right_create {
    ::v-deep .el-button {
