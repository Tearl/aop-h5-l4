...
import SelectFromFiledPool from "./components/selcFromFiledPool";
  ...
  methods: {
    ...
    handleCancel() {
      ...
      if(this.backType == "dataset") {
        this.$router.push({
            path: "/aop_service/dicmgmt/editDataSet",
            query: {
        ...
        this.$router.push({
          path: "/aop_service/dicmgmt/editSubstn",
          query: {
            dataSetNo: this.infoData.dataSetNo,
