                ...
                >
                  <div class="text_area">
                    ...
                    <span
                      ...
                      >已登记</span
                    > -->
                    <span v-if="item.statusCd == 0" class="list_item_tag new"
                      >新增
                    </span>
                    <span
                      v-if="item.statusCd == 1"
                      class="list_item_tag released"
                      >已入库</span
                    >
                    <span
                      v-if="item.statusCd == 2"
                      class="list_item_tag released"
                      >变更</span
                    >
                  ...
                  <!-- <div class="icon_area">
                    <el-tooltip effect="dark" :content="'编辑'" placement="top">
                      <i
                        class="el-icon-edit list_item_icon delete"
      ...
      menuDatasetList: [
        {
          ...
          children: [
            ...
            { dataSetNo: "FM-SJJ-110731", dataSetNm: "产品数据集8", status: "0" },
          ],
        },
      ],
      currentKey: "",
  ...
  methods: {
    ...
    d4bServClick(e) {
      ...
      this.timer = setTimeout(() => {
        this.currentD4bSvcId = e.l5SvcId;
    ...
    async getDataSetList(){
      ...
      this.defaultExpandedKeys.push(this.menuDatasetList[0].dataSetList[0].dataSetNo)
      ...
      this.$refs.menuDatasetRef.getCurrentKey(this.menuDatasetList[0].dataSetList[0].dataSetNo);
