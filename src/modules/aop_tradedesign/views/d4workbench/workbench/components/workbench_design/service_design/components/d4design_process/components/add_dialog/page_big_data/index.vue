  ...
  <div class="aop_workgate_comps_page_big_data">
    ...
    >
      <el-row v-if="type == ''" class="grid_no_re">
        <el-col :span="6"><div class="grid_header">参数名称</div></el-col>
        <el-col :span="4"><div class="grid_header">参数中文名称</div></el-col>
        <el-col :span="4"><div class="grid_header">参数描述</div></el-col>
