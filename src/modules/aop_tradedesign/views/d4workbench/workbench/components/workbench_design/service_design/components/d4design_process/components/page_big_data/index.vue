  ...
  <div class="aop_workgate_comps_page_big_data">
    ...
    >
      <el-row v-if="type == ''" class="grid_no_re">
        ...
        <el-col :span="3"><div class="grid_header">参数中文名称</div></el-col>
        ...
        <el-col :span="2"><div class="grid_header">验证规则</div></el-col>
        <el-col :span="3"><div class="grid_header">自定义规则</div></el-col>
        ...
        <div v-if="parentClass == 'temp_data' && $route.query.pageMode!='read'" class="grid_header_operation">
        ...
        <div class="grid_item" v-for="(item, index) in data" :key="index">
          ...
          <el-col :span="2"
            ><div class="grid_content">
              ...
              {{item.standType == "10" ? "系统贯标" : "手工贯标"}}
            </div></el-col
          >
          <el-col :span="2"
            ><div class="grid_content">
              <!-- <el-input
                v-model="item.checkRule"
                size="small"
                clearable
                placeholder=""
                disabled
          ...
          <!-- <el-col :span="2"
            ><div class="grid_content">
              <el-select v-model="item.isNeed" size="small">
                <el-option
          ...
          ></el-col> -->
          <div
            v-if="parentClass == 'temp_data' && $route.query.pageMode!='read'"
