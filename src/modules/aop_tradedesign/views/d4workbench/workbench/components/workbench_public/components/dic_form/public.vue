<template>
  <div class="aop_workgate_comps_systemmgmt_dic_form_public">
    <!-- 公共字典数据 -->
    <PageDialog
...
export default {
  ...
  methods: {
    ...
    paramsRadioChange(e, data) {
      this.paramsRadioModel = e.dictryNo;
      this.paramsDetail = e;
      console.log(this.paramsDetail)
    },
    closeDialog() {
      this.$refs.formRef.resetFields();
      this.paramsRadioModel = "";
...
.aop_workgate_comps_systemmgmt_dic_form_public {
