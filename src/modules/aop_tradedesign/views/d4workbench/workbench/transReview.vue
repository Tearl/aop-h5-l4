...
export default {
  ...
  methods: {
    ...
    commitAsset() {
      ...
      // location.href = `/h5-pc-terminal-web/layout_preview/#/reviewex?reviewId=${this.dataObj.rarId}&approvalType=00&orderId=${this.dataObj.isolateWorkspace}&funcId=${this.dataObj.funcId}&modelVersion=${this.dataObj.modelVersion}&action=${action}`;
    },
    designDetail() {
      window.open(
