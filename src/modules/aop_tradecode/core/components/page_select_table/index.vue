                ...
                >
                    ...
                    >
                        <el-select
                            ...
                            "
                            :clearable="
                                item.clearable == 'false' ? false : true
                            "
                            v-if="
                        ...
                        >
                            <el-option
                                ...
                                :value="i.value"
                                :disabled="
                                    i.disabled && i.disabled(scope, table)
                                "
                            ></el-option>
                        </el-select>
                        <div v-if="item.type == 'selectText'">
                            <el-select
                                ...
                                "
                                :disabled="
                                    item.disabled && item.disabled(scope, table)
                                "
                                :size="item.size ? item.size : 'small'"
                                :style="item.inputStyle"
                            >
                        ...
                        >
                            <el-input
                                ...
                                "
                                @input="
                                    (e) => item.input && item.input(e, scope)
                                "
                            ...
                            ></el-input>
                            <span
                                v-show="item.errorText && item.errorText(scope)"
                                class="error_text"
                                :style="{ left: item.width - 170 + 10 + 'px' }"
                                >{{ item.label }}不可为空</span
                            >
                        </div>
                        ...
                        <div v-else-if="item.type == 'inputBtn'">
                            ...
                            <div
                                v-else
                                @click="
                                    operate(item.btnItem.operate, scope.row)
                                "
                            >
                                <img
                                    ...
                                    class="icon"
                                    :style="
                                        item.btnItem.stylefun
                                            ? item.btnItem.stylefun(scope)
                                            : ''
                                    "
                                ...
                                <span
                                    v-else
                                    :class="
                                        item.btnItem.desc == '删除' ||
                                        item.btnItem.desc == '作废'
                                            ? 'btn_delete'
                                            : ''
                                    "
                        ...
                        <el-checkbox
                            ...
                            :size="item.size ? item.size : 'small'"
                            @change="
                                item.checkboxfun ? item.checkboxfun(scope) : ''
                            "
                        ...
                        <span
                            ...
                            "
                            :class="
                                item.textClass ? item.textClass : 'text_style'
                            "
                            @click="operate(item.operate, scope.row)"
                        >
                            {{ getFilters(scope.row[item.prop], item.filter) }}
                        </span>
                        <div v-else-if="item.type == 'partlyTextClick'">
                            <span>{{
                                getFilters(scope.row[item.prop], item.filter)
                            }}</span>
                            <span
                        ...
                        >
                            <div
                                v-for="(btnItem, i) in getShowBtnList(
                                    item.buttonList
                                )"
                                :key="i"
                                :class="
                                ...
                                "
                                v-if="
                                    getShowBtnList(item.buttonList).length > 3
                                        ? i < 2
                                        : true
                                "
                            ...
                            >
                                ...
                                <el-dropdown-menu slot="dropdown">
                                    <el-dropdown-item
                                        v-for="(dropItem, n) in getShowBtnList(
                                            item.buttonList
                                        )"
                                        :key="n"
...
export default {
    ...
    methods: {
        ...
        selectable(row, index) {
            if (!this.selectName) return true;
            else {
                if (row[this.selectName] == "1" || row[this.selectName] == "6" || row[this.selectName] == "5")
                    return true;
                else false;
            }
        },
