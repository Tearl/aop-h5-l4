<template>
  <div class="aop_tradecode_comps_dicmgmt_dic_form_enumerate" v-show="enumerateValueVisible">
    <PageDialog
    ...
    confirm() {
      ...
      this.$refs.enumerateValueFormRef.validate((valid) => {
        ...
        //   this.enumerateValueList.push(data);
            ...
            this.$emit('editData', this.enumerateValueForm)
        }
        this.enumerateValueVisible = false;
        this.$refs.enumerateValueFormRef.resetFields();
      });
...
.aop_tradecode_comps_dicmgmt_dic_form_enumerate {
  z-index: 1200;
  .top_right_create {
    ::v-deep .el-button {
