<template>
  <div class="aop_tradecode_download_design_comps_add_user_undefined">
    <PageDialog
      :dialogWidth="'70%'"
      :dialogTitle="'请选择元数据'"
    ...
    >
      ...
      <div slot="footer">
        <div class="show_conf" v-show="paramsDefault == 'choose' && isSelection">
...
export default {
  ...
  computed: {
    isSelection() {
      return this.selectType === 'selection' 
    }
  },
  methods: {
        // 单选
...
.aop_tradecode_download_design_comps_add_user_undefined {
}
