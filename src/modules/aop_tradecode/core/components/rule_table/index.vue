<template>
  <div class="aop_tradecode_comps_d4_edit_biz_rule_inner_table">
    ...
    <div v-else class="read_container">
      <el-table
        ...
        class="two_dimensional_array"
      >
        <el-table-column label="条件间关系" align="center" v-if="pageType == 'edit'">
          <template slot-scope="scope">
        ...
        <el-table-column class-name="condition_column" align="center" v-if="pageType == 'edit'">
          <template slot="header">
            <div class="header">
              <span class="title">条件项</span>
              <!-- <span class="icon plus" @click="showDialog('addColumn')">+</span> -->
        ...
        <el-table-column label="动作" align="center" v-if="pageType == 'edit'">
          <template slot-scope="scope">
        ...
        <el-table-column label="处理结果" align="center" v-if="pageType == 'edit'">
          <template slot-scope="scope">
        ...
        <el-table-column
          header-align="center"
          align="center"
          prop="apiServiceTypeNm"
          label="类型" >
        </el-table-column>
        <el-table-column label="操作" align="center">
          <div slot-scope="scope" class="operate_column">
            <span class="delete" @click="operate('checkRule', scope.row)"
              >查看</span
            >
          </div>
        </el-table-column>
...
export default {
  ...
  methods: {
    setRuleInfo(ruleInfo) {
      ...
      //   ];
      // }
      this.tableData = ruleInfo.ruleInfoList
    },
...
.aop_tradecode_comps_d4_edit_biz_rule_inner_table {
