<template>
  <div class="aop_tradecode_comps_d4_edit_biz_rule_inner_table_select_dict">
    <PageDialog
      :dialogWidth="'90%'"
      :dialogTitle="'请选择参数'"
      ...
      class="aop_tradecode_comps_d4_edit_biz_rule_inner_table_select_dict_append_to_bodye_dialog"
    >
      <div slot="box">
...
.aop_tradecode_comps_d4_edit_biz_rule_inner_table_select_dict {
  .container {
    padding: 16px;
  }
  .edit_form {
...
.aop_tradecode_comps_d4_edit_biz_rule_inner_table_select_dict_append_to_bodye_dialog {
  .el-dialog__body {
    padding: 0!important;
  }
  .add_dialog_conf1 {
