    ...
    <div class="aop_tradecode_comps_process">
        ...
        <div ref="svgBox" class="process_svg_box">
            ...
            >
                ...
                >
                    ...
                    <!-- 折线点上的圆圈 -->
                    <g v-show="item.checked">
                        <g
                            v-for="(point, index) in getPolylineArray(
                                item.polyline
                            )"
                            :key="index"
                        >
                            ...
                            <circle
                                ...
                                @mousedown.left="
                                    handlePolyLinePonitMouseDown($event, point)
                                "
                                @contextmenu.prevent="
                                    handlePolyLinePonitCm($event, point)
                                "
                                fill="transparent"
                            />
                        </g>
                ...
                >
                    ...
                    >
                        <p class="process_rect_text container">
                    ...
                    >
                        ...
                        <line
                            :class="{
                                process_line_circle_cap: isCircleClick,
                                hidden: item.actionType == 'sbsectAction',
                            }"
                        ...
                        <circle
                            ...
                            :r="itemOptions.circleR * 2"
                            @mousedown="
                                handleMoveLineMouseDown($event, 'left', item)
                            "
                            fill="transparent"
                        />
                        <!-- 右边小圈圈 -->
                        ...
                        <circle
                            ...
                            :r="itemOptions.circleR * 2"
                            @mousedown="
                                handleMoveLineMouseDown($event, 'right', item)
                            "
                            fill="transparent"
                        />
                        <!-- 上边小圈圈 -->
                        ...
                        <circle
                            ...
                            @mousedown="
                                handleMoveLineMouseDown($event, 'top', item)
                            "
                            fill="transparent"
                        />
                        <!-- 下边小圈圈 -->
                        ...
                        <circle
                            ...
                            @mousedown="
                                handleMoveLineMouseDown($event, 'bottom', item)
                            "
                            fill="transparent"
                        />
                    </g>
                ...
                >
                    ...
                    <rect
                        ...
                        :fill="
                            isAssetsDev &&
                            item.actionType != isDelArry[0] &&
                            item.actionType != isDelArry[1] &&
                            item.actionType != isDelArry[2] &&
                            item.actionType != isDelArry[3]
                                ? itemOptions.assetsDevBgClor
                                : itemOptions.itemBgClor
                        "
                        :stroke-width="
                            currentActionId == item.actionId || item.checkStroke
                                ? itemOptions.checkStrokeWidth
          ...
          /> -->
                    ...
                    <template v-if="fourRTypeList.includes(item.actionType)">
                        <rect
                            ...
                            "
                            :stroke-dasharray="
                                ['asyncAction'].includes(item.actionType)
                                    ? '4 2'
                                    : ''
                            "
                        />
              ...
              ({{ item.conf.filter((e) => e.name == "actionCode")[0].value }})
                    ...
                    >
                        ...
                        <p class="error_rect_msg">
                            {{
                                item.conf.filter((e) => e.name == "errorMsg")[0]
                                    .value
                            }}
                        </p>
                    </foreignObject>
                    ...
                    >
                        <p class="sbsect_action_text">
                            <span class="sbsect_name">
                                <el-tag
                                    v-if="isShowSbsectActionTag(item)"
                                    size="mini"
                                    type="danger"
                                    >new</el-tag
                                >
                            ...
                            <span v-if="!isRead" class="btn_area">
                                <i
                                    @click.stop="
                                        sbsectActionOperate('add', item)
                                    "
                                    class="icon el-icon-plus"
                                ></i>
                                <i
                                    @click.stop="
                                        sbsectActionOperate('merge', item)
                                    "
                                    class="icon el-icon-copy-document"
                                    :class="{
                                        disabled: isSbsectActionOperateDisabled(
                                            'merge',
                                            item
                                        ),
                                    }"
                                ...
                                <i
                                    @click.stop="
                                        sbsectActionOperate('split', item)
                                    "
                                ...
                                <i
                                    @click.stop="
                                        sbsectActionOperate('dataBase', item)
                                    "
                                    class="icon el-icon-coin"
                                ></i>
                                <i
                                    @click.stop="
                                        sbsectActionOperate('save', item)
                                    "
                        ...
                        <ul class="sbsect_action_field_list">
                            <li
                                v-for="field in getSbsectFieldList(item)"
                                :key="field"
                                class="sbsect_action_field_list_item"
                            >
                                <div class="text">{{ field.name }}</div>
                                <div class="tag_area">
                                    <span
                                        class="btn"
                                        v-if="field.canDelete"
                                        @click.stop="deleteField(item, field)"
                                        >删除</span
                                    >
                                    <span v-else>
                                        <el-tag
                        ...
                        <ul class="sbsect_action_l5service_list">
                            <li
                                v-for="l5service in getL5ServiceList(item)"
                                :key="l5service"
                                class="sbsect_action_l5service_list_item"
                            >
                                <div class="text">
                                    {{ `${l5service.svcNm}()` }}
                                </div>
                                <div class="tag_area">
                                    <el-tag
                                        v-if="l5service.status == 1"
                                        size="mini"
                                        type="danger"
                                        >新增</el-tag
                                    >
                                    <el-tag
                                        v-if="l5service.status == 2"
                                        size="mini"
                                        type="success"
                                        >更新</el-tag
                                    >
                                    <el-tag
                                        v-if="l5service.status == 3"
                                        size="mini"
                                        class="info"
                                        >删除</el-tag
                                    >
          ...
          /> -->
                    ...
                    >
                        <!-- <p class="d_rect_text">
                            <i
                                @click.stop="switch4RAction(item)"
                                class="icon el-icon-link"
                            ></i>
                        ...
                        <p
                            class="d_rect_code"
                            :class="{
                                'blue': ['4RAction', 'loopAction'].includes(
                                    item.actionType
                                ),
                    ...
                    >
                        <p class="process_rect_tips">
                            {{ item.stusCd | cpnStusCd }}
                        </p>
                    </foreignObject>
                    ...
                    <foreignObject
                        v-if="
                            ...
                            item.actionType != 'endAction'
                        "
                        :x="item.actionX + getItemWidth(item) - 13"
                        :y="item.actionY - 1"
                        :width="14"
                        :height="16"
                    >
                    ...
                    <foreignObject
                        v-if="item.actionType == 'sqlAction'"
                        :x="item.actionX + getItemWidth(item) - 39"
                        :y="item.actionY - 1"
                        :width="40"
                        :height="16"
                    >
                    ...
                    >
                        ...
                        <line
                            :class="{
                                ...
                                hidden:
                                    item.actionType == 'sbsectAction' ||
                                    subcomponentIdList.includes(item.actionId),
                            }"
                            :x1="getLeftCircleX(item, itemOptions)"
                            :y1="getLeftCircleY(item, itemOptions)"
                            :x2="getLeftCircleX(item, itemOptions)"
                    ...
                    <!-- 分段组件下的字段连线点 -->
                    <g
                        v-for="(fieldItem, fieldIndex) in getSbsectFieldList(
                            item
                        )"
                        :key="fieldItem"
                        v-show="
                    ...
                    >
                        ...
                        <line
                            :class="
                                isCircleClick ? 'process_line_circle_cap' : ''
                            "
                            :x1="item.actionX"
        ...
        <div
            ...
            :class="{
                hidden:
                    pageType == 'downDesign' &&
                    ['inputAction', 'outputAction'].includes(
                        itemObj.actionType
                    ),
            }"
            :style="{
            ...
            <div class="process_del">
                <ul>
                    <li v-for="item in rightClickMenuList" :key="item">
                        <p @click="toApply(item.operation, item.args)">
                            {{ item.text }}
                        </p>
                    </li>
                </ul>
...
import { escape2Html, html2Escape } from "@m/utils/html2e.js";
...
export default {
            ...
            defaultLineList: [
                {
                    ...
                    polyline:
                        "245.1092529296875 55.00421142578125 246.80853838230666 127",
                    checked: false,
                    drection: "bottom",
                    condition: {
                        condPrit: "0",
                ...
                },
                {
                    ...
                    y1: 151,
                    polyline:
                        "247.375 151 248.0011448620593 290.00421142578125",
                    checked: false,
                    drection: "bottom",
                    condition: {
                        condPrit: "0",
    ...
    computed: {
        _lineList() {
            if(this.process_type == '02') {
                return this.lineList
            } else {
                return this.lineList.filter(line => line.condition.priorityLevel == 1)
            }
        },
        _dataList() {
            console.log(this.dataList, this.fourRAttrFlag,  '_dataList')
            const dataList = this.dataList.filter(
                (item) => !this.containerTypeList.includes(item.actionType)
            );
            if(this.process_type== '01') {
                return dataList.filter(item => item.actionType != 'throwExceptionAction')
            }
        ...
        containerList() {
            return this.dataList.filter((item) =>
                this.containerTypeList.includes(item.actionType)
            );
        },
        subcomponentIdList() {
            return this.containerList.reduce((prev, container) => {
                const conf = this.getConfItem(
                    "subcomponent",
                    container.actionId
                );
        ...
        rightClickMenuList() {
            if (this.delType == "line") {
                return [{ text: "删除", operation: "handleDelLine" }];
            } else if (this.delType == "polylinePoint") {
                return [{ text: "删除", operation: "handleDelPolyLinePonit" }];
            } else {
    ...
    methods: {
        svgToPng(svgElement, svcSeq) {
            return new Promise((resolve, reject) => {
                ...
                img.onload = () => {
                    ...
                    canvas.toBlob((blob) => {
                        let _temp = new File([blob], `${svcSeq}.png`, {
                            type: "image/png",
                        });
        ...
        async getPicBySvg(svcSeq) {
            const svgElement = this.$refs.svgBox.querySelector("svg");
            const pngFile = await this.svgToPng(svgElement, svcSeq);
            return pngFile;
        },
        // 页面初始化
        init() {
            this.addEventListener();
            // this.rpc.transactionDesign.queryCacheIndexList({
            //   })
        },
        getDServText(item, str) {
            console.log(item, str, 'getDServText-----')
            let target = "";
            if (str == "svcTpCd") {
                target = item.conf.find((item) => item.name == str);
                if (target && target.value && target.value.indexOf("D4b") > -1)
                    return "D4b";
                if (
                    target &&
                    target.value &&
                    target.value.indexOf("D5自有") > -1
                )
                    return "自有服务";
                if (
                    target &&
                    target.value &&
                    target.value.indexOf("D5直连") > -1
                )
                    return "直连服务";
            } else {
                target = item.conf.find((item) => item.name == str);
        ...
        handleKeyup(ev) {
            if (ev.ctrlKey && ev.shiftKey && ev.keyCode == 90) {
                console.log(this.stepDataRecord, 'stepDataRecord---handleKeyup')
                //重做
                ...
                console.log(this.stepDataRecord, 'stepDataRecord---handleKeyup')
                //删除框选组件
                const checkList = this.dataList.filter(
                    (data) => data.checkStroke
                );
                if (this.rectList.show && checkList?.length) {
                    checkList.forEach((data) =>
                        this.handleItemBtnClick("del", data)
                    );
                }
                //删除单个组件
                const checkOne = this.dataList.find(
                    (item) => item.actionId == this.currentActionId
                );
                if (checkOne) this.handleItemBtnClick("del", checkOne);

                //删除线段
                let lineTrue = this.lineList.some(
                    (item) => item.checked == true
                );
                // console.log(lineTrue,"======")
                lineTrue && this.handleDelLine();
            }
        },
        // 创建选中矩形
        checkBoxSvgMove(ev) {
            ...
            document.onmousemove = throttle((ev) => {
                ...
                this.rectList.itemWidth =
                    nx1 - x1 > 0 ? nx1 - x1 : 0 - (nx1 - x1);
                this.rectList.itemHeight =
                    ny1 - y1 > 0 ? ny1 - y1 : 0 - (ny1 - y1);
                    ...
                    if (
                        ((this.rectList.actionX < item.actionX &&
                            ...
                            (this.rectList.actionX <
                                ...
                                this.rectList.actionY < item.actionY &&
                                item.actionY < lastY)) &&
                        !this.subcomponentIdList.includes(item.actionId)
                    ) {
        ...
        handleBackgroundCm(ev) {
            if (!getSessionStorage("pasteObj") || this.isRead || this.isTest)
                return;
        ...
        checkBoxrectMove(ev) {
            ...
            document.onmousemove = throttle((ev) => {
                ...
                if (currentX < 0) {
                    ...
                    currentX >
                    this.svgOptions.width - this.rectList.itemWidth
                ) {
        ...
        dataListMove(item, i, x, y, cx, cy) {
            ...
            console.log(this.lineList, 'lineList---dataListMove')
        },
        // 画布空白处点击
        handleSvgBgClick(e) {
            // if (this.isRead) return;
        ...
        handleLineClick(ev, item) {
            console.log('点击 line', item);
            // if (!item.relId) return;
            let timers = this.timer;
            if (timers) {
                window.clearTimeout(timers);
                this.timer = null;
            ...
            this.timer = window.setTimeout(() => {
                ...
                this.getSvgPos();
                this.clearAllLineCheck(this.lineList);
                console.log(this.lineList, 'handleLineClick-------');
                item.checked = true;
                this.isPopShow = false;
                this.isPastePopShow = false;
                this.currentActionId = "";
                this.lineObj = item;
                this.$emit("clickConditionLine", item.condition);
            }, 300); //大概时间300ms
            // if(item.relId) {
            //     this.$emit("clickConditionLine", item);
            // }
            // return
            // if (item.lineCondition) {
            //     // 点击条件分支
            //     console.log('点击 line', item);
            //     this.$emit("clickConditionLine", item);
            // } else {
            //     console.log('点击 line', ev, item);
            //     if(item.relId) {
            //         this.$emit("clickConditionLine", item);
            //     }
        ...
        handleLineMouseDown(event, item) {
            console.log("handleLineMouseDown", item, this.lineList);
            if (
                !(this.lineObj.checked && this.lineObj.lineId == item.lineId) ||
                this.isRead ||
                this.isTest
            )
                return;
            ...
            this.timer = window.setTimeout(() => {
                // 鼠标点击的线条上的坐标
                const clickLineX =
                    event.pageX - this.svgOptions.left - this.getScrollLeft();
                const clickLineY =
                    event.pageY - this.svgOptions.top - this.getScrollTop();
                const pointArr = item.polyline
                    .split(" ")
                    .reduce((prev, point, i, arr) => {
                        if (i % 2 == 0) {
                            prev.push({
                                x: arr[i] * 1,
                                y: arr[i + 1] * 1,
                ...
                let insertPointIndex = this.getInsertPointIndex(
                    pointArr,
                    clickLineX,
                    clickLineY
                );
        ...
        getInsertPointIndex(pointArr, clickLineX, clickLineY) {
            ...
            _pointArr.forEach((point, i, arr) => {
                const tan1 = Math.abs(
                    (clickLineY - arr[i].y) / (clickLineX - arr[i].x)
                );
                const tan2 = Math.abs(
                    (clickLineY - pointArr[point.index + 1].y) /
                        (clickLineX - pointArr[point.index + 1].x)
                );
            ...
            let resultIndex = _pointArr.find(
                (point) => point.tan == minTan
            ).index;
            return resultIndex + 1;
        },
        // 更新dataList中children的polyline
        updateDateListChildren(lineObj) {
            const children = this.dataList.find(
                (data) => data.actionId == lineObj.sourceId
            ).children;
            children.find((line) => line.lineId == lineObj.lineId).polyline =
                lineObj.polyline;
            this.getLineList(
                this.lineList,
                this.dataList,
                this.getItemWidth(lineObj),
                this.getItemHeight(lineObj)
            );
            this.lineObj = this.lineList.find(
                (line) => line.lineId == lineObj.lineId
            );
        ...
        handlePolyLinePonitMouseDown(ev, point) {
            ...
            let insertPointIndex = pointArr.findIndex(
            ...
            document.onmousemove = throttle((ev) => {
                ...
                if (mouseX < 0) mouseX = 0;
                    ...
                    mouseX = this.svgOptions.width - this.getItemWidth(item);
                if (mouseY < 0) mouseY = 0;
                else if (
                    mouseY >
                    this.svgOptions.width - this.getItemWidth(item)
                )
                    mouseY = this.svgOptions.width - this.getItemWidth(item);
                pointArr[insertPointIndex].x = mouseX;
                pointArr[insertPointIndex].y = mouseY;
        ...
        handleDelPolyLinePonit() {
            if (this.isRead) return;
            this.lineObj.polyline = this.lineObj.polyline.replace(
                `${this.polylinePointObj.x} ${this.polylinePointObj.y} `,
                ""
            );
            this.updateDateListChildren(this.lineObj);
        ...
        handleLineCm(ev, item) {
            // console.log("handleLineCm", ev, item);
            if (this.isRead) return;
            const endItem = this.dataList.find(
                (data) => data.actionId == item.targetId
            );
            if (endItem?.actionType == "throwExceptionAction") return;
            let timers = this.timer;
            if (timers) {
                window.clearTimeout(timers);
                this.timer = null;
        ...
        /**
         * removeInterfaceProcessActionLayoutRel
         * 删除接口流程组件编排关系
         */
        removeInterfaceProcessActionLayoutRel(id, actionId) {
            this.rpc.d4.removeInterfaceProcessActionLayoutRel({
                relId: id,
                actionId,
        ...
        handleDelLine() {
            if (this.isRead) return;
            const endItem = this.dataList.find(
                (data) => data.actionId == this.lineObj?.targetId
            );
            if (endItem?.actionType == "throwExceptionAction") return;
            let e = this.lineObj;
            let d = this.dataList.filter(
                (item) => item.actionId == e.sourceId.split("-")[0]
            )[0];
            d.children = d.children.filter((i) => i.lineId !== e.lineId);
            this.lineList.splice(this.lineList.indexOf(e), 1);
            // this.removeInterfaceProcessActionLayoutRel(e.relId)
        ...
        updateLineCondPrit() {
            ...
            this.dataList.forEach((item) => {
                item.children = item.children.filter(
                    (child) => linesIdArray.indexOf(child.lineId) > -1
                );
            });
            // 当组件的线大于2时，对线进行排序
            const moreThan2LinesData = this.dataList.filter(
                (item) => item.children.length >= 2
            );
            moreThan2LinesData &&
                moreThan2LinesData.forEach((data) => {
                    const min = Math.min(
                        ...data.children.map((item) => {
                            if(item.condition && item.condition.condPrit) {
                                return item.condition.condPrit
                            }
                        })
                    );
                    data.children.forEach((item) => {
                        if(item.condition) {
                            if (
                                item.condition.condPrit >=
                                data.children.length - 1 - min
                            )
                                item.condition.condPrit = `${
                                    item.condition.condPrit * 1 - 1
                                }`;
                        }
            ...
            const onlyOneLineData = this.dataList.filter(
                (item) => item.children.length == 1
            );
            onlyOneLineData &&
                onlyOneLineData.forEach((data) => {
                    data.children.forEach(
                       ((item) => {
                            if(item.condition) {
                                item.condition.condPrit = "0"
                            }
                        })
                    );
                });
        ...
        // 组件操作点击
        handleItemBtnClick(e, dataObj) {
            if (this.isRead) return;
            if (e === "edit") {
                console.log("组件点击编辑后触发");
                this.$emit("itemEditClick");
            } else if (e === "del") {
                let item = dataObj || this.itemObj;
                ...
                if (this.containerTypeList.includes(item.actionType)) {
                    ...
                    this.dataList = this.dataList.filter(
                        (data) => !subcomponent.includes(data.actionId)
                    );
                }
                // 删除附带异常组件的服务时，连异常组件一起删除
                if (
                    ["D4bAction", "D5SelfAction", "D5LinkAction"].includes(
                        item.actionType
                    )
                ) {
                    const relatedThrowExceptionAction = this.dataList.find(
                        (data) =>
                            this.getConfItem(
                                "relatedCompositeId",
                                data.actionId
                    ...
                    if (
                        relatedThrowExceptionAction &&
                        relatedThrowExceptionAction.actionType ===
                            "throwExceptionAction"
                    ) {
                        this.dataList.splice(
                            this.dataList.indexOf(relatedThrowExceptionAction),
                            1
                        );
                    }
                }
                // if(item.compositeId) {
                //     this.removeInterfaceProcessActionLayoutRel('', item.compositeId)
                // }
                ...
                this.lineList = this.lineList.filter(
                    (i) =>
                        i.targetId.split("-")[0] !== item.actionId &&
                        i.sourceId.split("-")[0] !== item.actionId
                );
                this.updateLineCondPrit();
                this.isPopShow = false;
                this.isPastePopShow = false;
                ...
                pasteObj.actionId =
                    pasteObj.actionType +
                    this.getNewRectId("Action", this.dataList);
            ...
            if (
                ...
                const loopList = this.dataList.filter((data) => {
                    if (data.actionType == "loopAction") {
                        const loopListSource = this.getConfItem(
                            "loopListSource",
                            data.actionId
                        )?.value;
                ...
                if (loopList.length) {
                    const loopNames = loopList.reduce(
                        (prev, loopAction, index, arr) => {
                            return `${prev}${loopAction.actionName}${
                                index == arr.length - 1 ? "" : "、"
                            }`;
                        },
                        ""
                    ...
                    return (
                        this.$message.error(
                            `${item.actionName}是${loopNames}的循环集合来源，无法删除！`
                        ) && false
                    );
                }
                ...
                const referenceList = this.dataList.filter((data) => {
                    if (
                        data.compositeId &&
                        data.compositeId != item.compositeId
                    ) {
                        const layoutAction = this.layoutActionList.find(
                            (layoutData) =>
                                layoutData.actionId == data.compositeId
                        );
                        const tfrCdtnCd = JSON.parse(
                            layoutAction?.tfrCdtnCd || "[]"
                        );
                        return tfrCdtnCd.some(
                            (_tfrCdtnCd) =>
                                _tfrCdtnCd.actionId == item.compositeId
                        );
                    }
                });
                if (referenceList.length) {
                    const referenceNames = referenceList.reduce(
                        (prev, referenceItem, index, arr) => {
                            return `${prev}${referenceItem.actionName}${
                                index == arr.length - 1 ? "" : "、"
                            }`;
                        },
                        ""
                    ...
                    return (
                        this.$message.error(
                            `${item.actionName}是${referenceNames}的交易编排来源，无法删除！`
                        ) && false
                    );
                }
            } else if (
                ...
                // 输入输出组件不能删除，异常组件需要在相连的服务组件的属性中编辑进行删除
                return false;
            }
            return true;
        },
        ...
        handleMoveMD(event, item, itemOptions) {
            ...
            const subcomponent = JSON.parse(conf.value || "[]");
            // 容器组件的坐标区间
            const containerAreaMap = this.containerList.reduce(
                (prev, item, index) => {
                    prev[item.actionId] = {
                        x: [
                            item.actionX,
                            item.actionX +
                                this.getContainerActionWidth(item, itemOptions),
                        ],
                        y: [
                            item.actionY,
                            item.actionY +
                                this.getContainerActionHeight(
                                    item,
                                    itemOptions
                                ),
                        ],
            ...
            document.onmouseup = () => {
                ...
                if (
                    ...
                    const containerId = this.getIntersectionContainer(
                        item,
                        containerAreaMap
                    );
                    if (containerId) {
    ...
    */
        handleMoveLineMouseDown(ev, drection, item) {
            ...
            let lineObj = {};
            const lineType =
                this.processMode == "complex" &&
                item.children.some(
                    (child) =>
                        child.lineType == "line" &&
                        !child.targetId.includes("throwExceptionAction")
                )
                    ? "polyline"
                    : "line";
            ...
            document.onmouseup = async (ev) => {
                ...
                for (let i = 0; i < this.dataList.length; i++) {
                    if (this.dataList[i] !== item) {
                        ...
                        if (flag) {
                            ...
                            if (
                                this.subcomponentIdList.includes(
                                    this.dataList[i].actionId
                                )
                            ) {
                                const container = this.containerList.find(
                                    (container) => {
                                        const conf = this.getConfItem(
                                            "subcomponent",
                                            container.actionId
                                        );
                                        const subcomponent = JSON.parse(
                                            conf.value || "[]"
                                        );
                                        return subcomponent.includes(
                                            this.dataList[i].actionId
                                        );
                                    }
                                );
                ...
                if (flag) {
                    ...
                    //     this.lineList.some(
                    //         (line) =>
                    //             line.targetId == endItem.actionId &&
                    //             endItem.actionType != "throwExceptionAction"
                    //     )
                    // ) {
                    //     document.onmousemove = null;
                    //     document.onmouseup = null;
                    ...
                    //     this.lineList.pop();
                    //     return this.$message.error(
                    //         `组件【${endItem.actionName}】已存在连线，如需重新连线请先删除原连线`
                    //     );
                    // } else
                     if (endItem.actionType == "inputAction") {
                        document.onmousemove = null;
                        document.onmouseup = null;
                        this.isCircleClick = false;
                        this.lineList.pop();
                        return this.$message.error(
                            `组件【${item.actionName}】只能作为编排起点`
                        );
                    }
                    ...
                    //   this.isCircleClick = false;
                    //   this.lineList.pop()
                    //   return this.$message.error(`请将L5服务组件与【${endItem.actionName}】连线33`)
                    // }
                    else if (
                        endItem.actionType == "uploadAction" &&
                        item.actionType != "inputAction"
                    ) {
                        document.onmousemove = null;
                        document.onmouseup = null;
                    ...
                    if(endItem.actionType != "D5SelfAction" && !endItem.compositeId) {
                        document.onmousemove = null;
                        document.onmouseup = null;
                        this.isCircleClick = false;
                        this.lineList.pop();
                        return this.$message.error(
                            `请先将${endItem.actionName}组件右侧属性面板配置完成！`
                        );
                    }
                    // 同一组件存在分支连线时，只能连接到异常组件
                    // lineListStartWithItem = this.lineList.filter((line) => {
                    //     const targetItem = this.dataList.find(
                    //         (data) => data.actionId == line.targetId
                    //     );
                    //     return (
                    //         line.sourceId == item.actionId &&
                    //         targetItem.actionId == line.targetId &&
                    //         targetItem.actionType != "throwExceptionAction"
                    //     );
                    // });
                    // if (
                    //     lineListStartWithItem?.length &&
                    //     endItem.actionType != "throwExceptionAction"
                    // ) {
                    //     document.onmousemove = null;
                    //     document.onmouseup = null;
                    ...
                    //     this.lineList.pop();
                    //     return this.$message.error(
                    //         `组件【${item.actionName}】已存在连线，如需重新连线请先删除原连线`
                    //     );
                    // }
                    ...
                    if (this.lineType == "polyline") {
                        ...
                        // 添加流程组件编排关系
                        branchObj = this.addInterfaceProcessActionLayoutInfo(item, endItem)
                        // 新增新增流程组件编排关系
                        // let relId = await this.addInterfaceProcessActionLayoutRel(item, endItem).catch(err => {
                        //     document.onmousemove = null;
                        //     document.onmouseup = null;
                        //     this.isCircleClick = false;
                        //     this.lineList.pop();
                        ...
                        console.log(
                            "生成连接线后触发",
                            JSON.parse(JSON.stringify(lineObj))
                        );
                    }
                    ...
                    // Object.assign(lineObj, branchObj)
                    item.children.push({
                ...
                document.onmouseup = null;
                this.isCircleClick = false;
                console.log(lineObj, 'lineObj在圆点鼠标放开后触发')
                
                // this.$emit('toSave')
                this.$emit("getAttrEvent", {actionType: 'lineAction', ...branchObj}, false);
                // this.lineType = "line"
                console.log("在圆点鼠标放开后触发(无论是否生成新线条)", this.lineList);
            };
        },
         ...
         * 每次连线时生成新的编排关系数据
         */
        addInterfaceProcessActionLayoutInfo(start, end) {
            return {
                relId: '',
                ...
                endActionType: '00',
                relDesc: '',
                startActionId: start.compositeId,
                endActionId: end.compositeId,
                executeConditionJson: '[]',
                priorityLevel: 1,
         ...
         * 新增接口流程组件编排关系
         */
        async addInterfaceProcessActionLayoutRel(start, end) {
    ...
    */
        ...
        handleNewRectMousedown(e) {
            console.log("handleNewRectMousedown", e, this.isRead);
            if (this.isRead) return;
            this.currentActionId = "";
            let ev = e.ev;
            this.getSvgPos();
            ...
            const containerAreaMap = this.containerList.reduce(
                (prev, item, index) => {
                    prev[item.actionId] = {
                        x: [
                            item.actionX,
                            item.actionX + this.getContainerActionWidth(item),
                        ],
                        y: [
                            item.actionY,
                            item.actionY + this.getContainerActionHeight(item),
                        ],
                    };
                    return prev;
                },
            ...
            document.onmousemove = throttle((ev) => {
                ...
                if (
                    [
                        ...
                        "D5LinkAction",
                        "captchaAction",
                    ].includes(this.currentMoveItem.actionType)
                ) {
                    this.getIntersectionContainer(
                        this.currentMoveItem,
                        containerAreaMap
                    );
                }
            ...
            document.onmouseup = async (ev) => {
                document.onmousemove = null;
                document.onmouseup = null;
                // this.getConfItem("actionSeq", this.currentMoveItem.actionId).value = this.setNewActionSeq()
                // console.log("🚀 ~ document.onmousemove=throttle ~ this.setNewActionSeq():", this.setNewActionSeq(),this.dataList)
                this.$emit(
                    "handleNewRectAdd",
                    this.currentMoveItem,
                    this.dataList
                ...
                console.log(
                    "this.currentMoveItem",
                    JSON.parse(JSON.stringify(this.currentMoveItem)),
                    this.dataList,
                    "dataList"
                );
                if (
                    this.currentMoveItem.actionType === "updateCacheAction" ||
                    this.currentMoveItem.actionType === "getCacheAction"
                ) {
                    let cacheConList = JSON.parse(
                        getSessionStorage("cacheConList")
                    );
                    if (!cacheConList.length) {
                        this.$message.error("需要在流程图中使用设置缓存组件");
                        this.dataList.pop();
                        return;
                    }
                }
                if (
                    this.currentMoveItem.actionName &&
                    this.currentMoveItem.actionType
                ) {
                    console.log(this.currentMoveItem, 'currentMoveItem--------------')
                    if (
                        [
                            "D5SelfAction"
                        ].includes(this.currentMoveItem.actionType)
                    ) {
                        const { copositeIdList } = await this.rpc.d4.generateCompositeId({
                        num: 1,
                        });
                        this.currentMoveItem.compositeId = copositeIdList[0]
                    }
                    // 把组件拖进了画布
        ...
        //组件点击
        handleItemClick(e, click = true) {
            // 如果是异常组件就返回
            if (
                ["throwExceptionAction"].includes(e.actionType)
            ) {
                return;
            }
            // 默认点击触发，拖拽组件触发时click = false
            if (this.handleItemClick.timer)
        ...
        handleItemCm(ev, item) {
            // console.log("handleItemCm", ev, item);
            if (this.isRead) return;
            if (
                ...
                return;
            if (item.actionType == "throwExceptionAction") return;
            let timers = this.timer;
            if (timers) {
                window.clearTimeout(timers);
                this.timer = null;
        ...
        updateProcessMain() {
            ...
            for (let i in me.dataList) {
                ...
                for (let p in me.lineList) {
                    if (
                        me.lineList[p].sourceId.split("-")[0] ==
                        me.dataList[i].actionId
                    ) {
                        let d = me.lineList[p];
                        d.lineId = this.getLineId() + p;
                        d.lineType =
                            me.lineList[p].polyline == "1"
                                ? "polyline"
                                : "line";
                        children.push(d);
                    }
        ...
        upDateServParams(obj, e) {
            ...
            if (
                ...
                const target = this.dataList.find(
                    (item) => item.actionId == obj.actionId
                );
                target.paramList = e.paramList.map(param => {
                    return {
                        ...param,
                        serviceId: obj.compositeId
                    }
                });
                const x1 =
                    target.actionX + this.getItemWidth(target) / 2;
                const y1 =
                    target.actionY + this.getItemHeight(target) / 2;
                const x2 = target.actionX + this.getItemWidth(target) / 2;
                const y2 = target.actionY + this.getItemHeight(target) / 2;
                if(obj.branchList.length == 0) return
                // 处理编排关系和异常信息
                obj.branchList.forEach(br => {
                    if(target.children.length > 0) {
                        target.children.forEach(tar => {
                            if(tar.condition.startActionId == br.startActionId && tar.condition.endActionId == br.endActionId) {
                                if(br.endActionType == '00') {
                                    tar.condition.executeConditionJson = br.executeConditionJson
                                    tar.condition.priorityLevel = br.priorityLevel
                                    tar.condition.relDesc = br.relDesc
                                    tar.condition.relDescType = br.relDescType
                                } else {
                                    tar.condition.endActionType = br.endActionType
                                    tar.condition.priorityLevel = br.priorityLevel
                                    tar.condition.relDesc = br.relDesc
                                    tar.condition.relDescType = br.relDescType
                                    tar.condition.exceptionActionInfo = br.exceptionActionInfo
                                }
                            } else {
                                if(br.endActionType == '00') {
                                let item = {
                ...
                // 处理异常组件
                const relatedThrowExceptionAction = obj.branchList.filter(item => item.endActionType == '01')
                if(relatedThrowExceptionAction.length >0) {
                    // 已经生成了异常组件，此时删除异常组件,重新添加
                    target.children = target.children.filter(e => !e.targetId.includes('throwExceptionAction'))
                    this.dataList = this.dataList.filter(item => !item.actionId?.includes('throwExceptionAction'));
                    relatedThrowExceptionAction.forEach(async error => {
                        const res = await this.rpc.d4.generateCompositeId({
                            num: 1,
                        });
                        // 服务组件填写了错误码、错误信息，且没有对应的异常组件时，生成相应的异常组件并连线
                        let actionId = "throwExceptionAction" +
                                this.getNewRectId("Action", this.dataList)
                        const item = {
                            actionId: actionId,
                            compositeId: res.copositeIdList[0],
                            actionOwnId: "",
                            actionName: "异常组件",
                            actionX:
                                target.actionX + this.getItemWidth(target) + 50,
                            actionY: target.actionY,
                            actionCoverShow: false,
                            color: "#333",
                            children: [],
                            actionPoint: "",
                            actionType: "throwExceptionAction",
                            paramList: [],
                            conf: [
                                {
                                    name: "actionDesc",
                                ...
                                {
                                    name: "relatedCompositeId",
                                    value: obj.compositeId,
                                },
                            ],
                        };
                        error.exceptionActionInfo.actionCd = actionId
                        error.exceptionActionInfo.actionId = error.endActionId
                        this.dataList.push(item);
                        const x1 =
                            target.actionX + this.getItemWidth(target) / 2;
                        const y1 =
                            target.actionY + this.getItemHeight(target) / 2;
                        const x2 = item.actionX + this.getItemWidth(item) / 2;
                        const y2 = item.actionY + this.getItemHeight(item) / 2;
                        target.children.push({
                            targetId: item.actionId,
                            sourceId: target.actionId,
                            begin: "right",
                            end: "left",
                            lineId: this.getLineId(),
                            condition: error,
                    ...
                    console.log(this.dataList, 'upDateServParams--dataList')
                } else {
                    
                    // 已经生成了异常组件，但删掉了错误码、错误信息，此时删除对应异常组件
                    target.children = target.children.filter(e => !e.targetId.includes('throwExceptionAction'))
                        // target.children.splice(target.children.findIndex(e => e.targetId.includes('throwExceptionAction')), 1)

                        this.dataList = this.dataList.filter(item => !item.actionId?.includes('throwExceptionAction'));
                        this.lineList = this.lineList.filter(
                            (i) =>
                                !i.targetId.split("-")[0].includes('throwExceptionAction')
                        );
                        console.log(this.dataList, 'upDateServParams--dataList')
                }
                // if (!relatedThrowExceptionAction) {
                ...
                // } else {
                //     if (errorCode && errorMsg) {
                //         // 已经生成了异常组件，且填写了错误码、错误信息，则更新对应信息
                //         relatedThrowExceptionAction.conf.forEach((conf) => {
                //             if (conf.name == "errorCode")
                //                 conf.value = errorCode;
                //             if (conf.name == "errorMsg") conf.value = errorMsg;
                //         });
                //     } else {
                //         // 已经生成了异常组件，但删掉了错误码、错误信息，此时删除对应异常组件
                //         this.dataList.splice(
                ...
                //             (i) =>
                //                 i.targetId.split("-")[0] !==
                //                     relatedThrowExceptionAction.actionId &&
                //                 i.sourceId.split("-")[0] !==
                //                     relatedThrowExceptionAction.actionId
                //         );
                //     }
                ...
                obj.actionType == "inputAction" ||
                obj.actionType == "outputAction"
            ) {
                const target = this.dataList.find(
                    (item) => item.actionId == obj.actionId
                );
                ...
                target.actionName = e.confList.find(
                    (item) => item.confKey == "actionDesc"
                )?.confValue;
            } else if (
                [
                    "cacheSessionAction",
            ...
            } else if(obj.actionType === "captchaAction") {
                const target = this.dataList.find(
                    (item) => item.actionId == obj.actionId
                );
                target.conf = e.confList.map((item) => {
                ...
                obj.actionType == "loopAction" ||
                obj.actionType == "transferStateAction" ||
                obj.actionType == "listAction" ||
                obj.actionType == "complex" ||
                obj.actionType == "autoAction" ||
                obj.actionType == "setHeaderAction" ||
                obj.actionType == "keyMapAction" ||
                obj.actionType == "timeAction" ||
                obj.actionType == "updateCacheAction" ||
                obj.actionType === "updateSessionAction" ||
                obj.actionType === "setCacheAction" ||
                obj.actionType === "spliceAction" ||
                obj.actionType === "getCacheAction" ||
                obj.actionType === "listSetValAction" ||
                obj.actionType === "desensitizationAction" ||
                obj.actionType === "getDesensitizationAction" ||
                obj.actionType === "setDesensitizationAction" ||
                obj.actionType === "getFlowNumAction"
            ) {
                const target = this.dataList.find(
                    (item) => item.actionId == obj.actionId
                );
                ...
                const inputCpn = this.dataList.find(
                    (item) => item.actionType == "inputAction"
                );
                const outputCpn = this.dataList.find(
                    (item) => item.actionType == "outputAction"
                );
                try {
            ...
            } else if(obj.actionType == 'uploadAction') {
                const target = this.dataList.find(
                    (item) => item.actionId == obj.actionId
                );
                target.paramList = e.paramList.map(param => {
                ...
                if (this.dataList[i].actionId == e.sourceId) {
                    for (let k in this.dataList[i].children) {
                        if (this.dataList[i].children[k].lineId == e.lineId) {
                            this.dataList[i].children[k].condition =
                                e.condition;
                        }
                    }
                }
        ...
        findTargetId(actionPostSeq, e) {
            let _e = null
            for (let i of e) {
                let _conf = i.conf.filter(k => k.name == "actionSeq")[0];
                if (_conf.value == actionPostSeq) {
                    _e = i;
                    break;
                }
            }
        ...
        calcPolyline(source_id, target_id, _data) {
            console.log('source?????', source_id, target_id, _data);
            let source = _data.filter(d => d.compositeId == source_id)[0]
            console.log('source?????', source);
            
            let target = _data.filter(d => d.compositeId == target_id)[0]
            console.log('target?????', target);
            const x1 = source.actionX + this.getItemWidth(source) / 2;
            const y1 = source.actionY + this.getItemHeight(source) / 2;
            const x2 = target.actionX + this.getItemWidth(target) / 2;
            const y2 = target.actionY + this.getItemHeight(target) / 2;
            return `${x1} ${y1} ${x2} ${y2}`;
        ...
        //映射数据
        async mapData(e, po) {
            console.log("🚀 ~ mapData ~ e:", e, po, this.currentServObj)
            
            let list = [];
            let ll = [];
            for (let i in e) {
                let pp = JSON.parse(po);
                console.log(pp, 'position---jsn.parse')
                let p = pp[e[i].id].split(" ");
                let d = {
                    actionId: e[i].id,
                    actionOwnId: e[i].cpntId,
                    actionType: e[i].type,
                    actionName: e[i].conf.filter(
                        (item) => item.name == "actionDesc"
                    ).length ? e[i].conf.filter(
                        (item) => item.name == "actionDesc"
                    )[0].value : "",
                    actionX: p[0] * 1,
                    actionY: p[1] * 1,
            ...
            this.dataList = list;
            for(let i in e) {
            const tfrCdtnCd = JSON.parse(e[i].tfrCdtnCd || "[]");
            console.log('tfrCdtnCd===========>',tfrCdtnCd);

            if (this.process_type == '02') {
                let conditionList = []
                for (let k in e[i].transition) {
                    conditionList = [...JSON.parse(e[i].transition[k].condition.executeConditionJson)]
                    console.log(conditionList, 'conditionList------')
                    let n = {
                        // sourceId: e[i].id,
                        sourceId: e[i].transition[k].name.split(".")[0],
                        targetId: e[i].transition[k].value,
                        relId: e[i].transition[k].relId,
                        condition: e[i].transition[k].condition,
                        begin: "bottom",
                        end: "top",
                        lineType: "line",
                        polyline: e[i].transition[k].polyline || "",
                        isTfrCdtnCd: false,
                        lineCondition: conditionList
                    };
                    ll.push(n);
                }
            } else {
            ...
            // if (tfrCdtnCd.length && this.process_type == '02') {
            //     for (let k in tfrCdtnCd) {
            //         console.log('kkkkkkkkkkk=>', tfrCdtnCd[k]);
                    
            //         // 简单模式
            //         if (tfrCdtnCd[k].actionPostSeq) {
            //             let _e = this.findTargetId(tfrCdtnCd[k].actionPostSeq, e);
                    
            //             if (_e) {
            //                 let n = {
            //                     lineCondition: tfrCdtnCd[k],
            //                     isTfrCdtnCd: true,
            //                     sourceId: e[i].id,
            //                     targetId: _e.id,
            //                     begin: "bottom",
            //                     end: "top",
            //                     lineType: "line",
            //                     polyline: this.calcPolyline(e[i].compositeId, _e.compositeId, this.dataList), // 用 this.dataList 计算 polyline
            //                 };
            //                 ll.push(n);
            //             }
            //         } else if (tfrCdtnCd[k].activityNextSeq) {
            //             // 复杂模式
            //             let _e = this.findTargetId(tfrCdtnCd[k].activityNextSeq, e);
            //             console.log(e[i].id,_e.id, `${e[i].id}-${_e.id}`, 'e[i].transition=====')
            //                     if (_e) {
            //                     let n = {
            //                         lineCondition: tfrCdtnCd[k].conditionList,
            //                         isTfrCdtnCd: false,
            //                         sourceId: e[i].id,
            //                         targetId: _e.id,
            //                         relId: transtionMapList.filter(h => h.key == `${e[i].id}-${_e.id}`)[0].value,
            //                         begin: "bottom",
            //                         end: "top",
            //                         lineType: "line",
            //                         checked: true,
            //                         polyline: this.calcPolyline(e[i].compositeId, _e.compositeId, this.dataList), // 用 this.dataList 计算 polyline
            //                     };
            //                     // if(transtionMapList.filter(h => h.key == `${e[i].id}-${_e.id}`)[0].value == this.lineObj.relId) {
            //                     //     n.checked = true
            //                     // }
            //                     ll.push(n);
            ...
            console.log(this.lineList, 'lineList1------')
            ...
            if (this.pageType == "mainFlow") {
                const actionIdToErrorMsg = this.dataList.reduce(
                    (prev, data) => {
                        const errorConf = this.getConfItem(
                            "error",
                            data.actionId
                        );
                        if (errorConf.value) {
                ...
                this.dataList.forEach((item, index, array) => {
                    if (index < array.length - 1) {
                        const endItem = array[index + 1];
                        const x1 = item.actionX + this.getItemWidth(item) / 2;
                        const y1 = item.actionY + this.getItemHeight(item) / 2;
                        const x2 =
                            endItem.actionX + this.getItemWidth(endItem) / 2;
                        const y2 =
                            endItem.actionY + this.getItemHeight(endItem) / 2;
                        item.children.push({
                            targetId: endItem.actionId,
                            sourceId: item.actionId,
                            begin: "",
                ...
                // 生成错误组件
                for (let actionId in actionIdToErrorMsg) {
                    const { item, error } = actionIdToErrorMsg[actionId];
                    const endItem = {
                        actionId:
                            "errorAction" +
                            this.getNewRectId("Action", this.dataList),
                    ...
                    this.dataList.push(endItem);
                    // 生成连接线
                    const x1 = item.actionX + this.getItemWidth(item) / 2;
                    const y1 = item.actionY + this.getItemHeight(item) / 2;
                    const x2 = endItem.actionX + this.getItemWidth(endItem) / 2;
                    const y2 =
                        endItem.actionY + this.getItemHeight(endItem) / 2;
                    item.children.push({
                        targetId: endItem.actionId,
        ...
        map4RData(e, po, item) {
            console.log(
                ...
                e,
                po,
                JSON.parse(JSON.stringify(this._dataList))
            );
            ...
            // this.fourRDataMap[item.actionId] = list;
        ...
        // 记录当前的画布数据
        markCurrentDate() {
            console.log(this.stepDataRecord, 'this.stepDataRecord--markCurrentDate')
            let { index, data } = this.stepDataRecord;
            data[index] = {
            ...
            if (data.length > this.stepDataRecord.index)
                data.length = this.stepDataRecord.index;
        },
        //条件排列
        conditionString(e) {
            let d = "";
            ...
            for (let i in k) {
                d =
                    d +
                    (i * 1 == 1
                        ? " " + filters.condAndOr(k[i].mtchMode) + " "
                        : "") +
                    k[i].sorcParaNm +
        ...
        getLineText(lineObj, showAll = false) {
            if (
                lineObj.sourceId &&
                lineObj.sourceId.indexOf("judgeAction") > -1
            ) {
                try {
                    const judgeCpn = this.dataList.find(
                        (item) => item.actionId == lineObj.sourceId
                    );
                    const paramList = JSON.parse(
                        judgeCpn.conf.find((item) => item.name == "paramList")
                            ?.value
                    );
                    const item = paramList.find(
                        (item) => item.targetId == lineObj.targetId
                    );
                    ...
                    let result = item
                        ? `${
                              ...
                              item.otherApSource == "40"
                                  ? item.otherParamValue
                                  : item.otherParamCName
                          }`
                        : "";
                    return showAll
                        ? result
                ...
                lineObj.sourceId &&
                lineObj.sourceId.indexOf("sbsectAction") > -1
            ) {
        ...
        getLineTextByCondition(item) {
            if (Array.isArray(item.lineCondition)) {
                // 解析数组
                let str = "";
                for (let con of item.lineCondition) {
                    str += `${con.paramNm} ${con.condTyp} ${con.paramValueNm || con.paramValue} ${con.groupOperator} `
                }
                return str;
            } else {
                if (item.lineCondition) {
                    return `${item.lineCondition.paramNm} ${item.lineCondition.condTyp} ${item.lineCondition.paramValueNm || item.lineCondition.paramValue}`
                }
            }
            
        },
        clickLineTextByCondition(item) {
            console.log('line', item);
            this.$emit("clickConditionLine", item.lineCondition);
        ...
        getPolylineTextX(lineObj, oldX) {
            const source = this.dataList.find(
                (item) => item.actionId == lineObj.sourceId?.split("-")[0]
            );
            const target = this.dataList.find(
                (item) => item.actionId == lineObj.targetId?.split("-")[0]
            );
            if (source?.actionX && target?.actionX) {
                if (source.actionType == "sbsectAction") {
                    ...
                    const begin = source.children?.find(
                        (child) => child.sourceId == lineObj.sourceId
                    )?.begin;
                    const end = source.children?.find(
                        (child) => child.sourceId == lineObj.sourceId
                    )?.end;
                    const sourceFieldX =
                        begin == "left"
                    ...
                    if (sourceFieldX < targetFieldX) {
                        return (
                            targetFieldX -
                            Math.abs(sourceFieldX - targetFieldX) / 2
                        );
                    } else {
                        return (
                            targetFieldX +
                    ...
                    if (source.actionX < target.actionX) {
                        return (
                            target.actionX -
                            Math.abs(source.actionX - target.actionX) / 2
                        );
                    } else {
                        return (
                            target.actionX +
        ...
        handleLineTextMouseClick(item, event) {
            ...
            if (item.sourceId.indexOf("sbsectAction") > -1) {
                ...
                const target = this.dataList.find(
                    (data) => data.actionId == item.sourceId
                );
        ...
        handleCondPritChange(newCondPrit, oldCondPrit, lineObj) {
            const sameSourceLines = this.lineList.filter(
                (item) => item.sourceId == lineObj.sourceId
            );
            const line = sameSourceLines.find(
                (item) =>
                    item.condition.condPrit == newCondPrit &&
                    item.lineId != lineObj.lineId
            );
        ...
        getInputOrOutputItemPoints(item, itemOptions) {
            ...
            return `${actionX},${actionY} ${actionX},${actionY + height} ${
                actionX + width - 20
            },${actionY + height} ${actionX + width},${actionY + height / 2} ${
                actionX + width - 20
            },${actionY}`;
        },
        // 双击组件
        handleItemDouble(e) {
            clearTimeout(this.handleItemClick.timer);
            if (
                ["4RAction", "loopAction", "asyncAction"].includes(e.actionType)
            ) {
                console.log("双击了组件", e);
                ...
                if (!actionSeq || actionSeq.includes("位置序号"))
                    return this.$message.error("请先设置组件的位置序号");
         ...
         */
        setNewActionSeq() {
            // 找到所有conf中name为'actionSeq'的value
            const actionSeqValues = this.dataList
                .map(item => item.conf)
                .flat()
                .filter(conf => conf.name === 'actionSeq')
                .map(conf => conf.value.trim())  // 去除value中的空格
                .filter(value => value !== '');  // 去除空字符串
            // 提取数字部分并找出最大值
            const maxSeq = actionSeqValues
                .map(value => {
                // 确保value是以'R'开头并且去掉'R'后的部分是有效的数字
                const num = value.replace('R', '');
                console.log("🚀 ~ num ~ num:", num)
                return isNaN(num) ? 0 : parseInt(num, 10); // 如果替换后的数字无效，返回0
                })
                .reduce((max, curr) => Math.max(max, curr), 0);
            // 生成下一个actionSeq，保持4位数字格式
        ...
        setActionSeq() {
            ...
            // 设置input组件的序号为R0000
            const inputAction = this.dataList.find(
                (item) => item.actionType == "inputAction"
            );
            let actionSeq = "R0000";
            inputAction.conf.find((item) => item.name == "actionSeq").value =
                actionSeq;
            let nextItem = this.getNextSettingItem(inputAction);
            while (nextItem) {
                actionSeq = this.actionSeqFormat(actionSeq.slice(1) * 1 + 1);
                this.getConfItem("actionSeq", nextItem.actionId).value =
                    actionSeq;
                if (this.containerTypeList.includes(nextItem.actionType)) {
                    ...
                    subcomponent.forEach((subItem, index) => {
                        const actionSeqConf = this.getConfItem(
                            "actionSeq",
                            subItem
                        );
                        const actionFrntSeqConf = this.getConfItem(
                            "actionFrntSeq",
                            subItem
                        );
                        const actionPostSeqConf = this.getConfItem(
                            "actionPostSeq",
                            subItem
                        );
                        actionSeqConf.value =
                            actionFrntSeqConf.value =
                            actionPostSeqConf.value =
                                "";
                        actionSeqConf.value = `${actionSeq}-${this.actionSeqFormat(
                            index + 1
                        )}`;
                        // if (index != 0) {
                        ...
                        // }
                        actionFrntSeqConf.value = this.actionSeqFormat(
                            actionSeq.slice(1) * 1 - 1
                        );
                        actionPostSeqConf.value = this.actionSeqFormat(
                            actionSeq.slice(1) * 1 + 1
                        );
                    });
                }
            ...
            // 设置组件的前序和后序ID
            this.dataList.forEach((data) => {
                const lineList = this.lineList.filter(
                    (line) =>
                        line.targetId == data.actionId &&
                        this.getConfItem("actionSeq", line.sourceId).value
                );
                const actionFrntSeq = lineList.reduce((prev, item, index) => {
                    return `${prev}${
                        this.getConfItem("actionSeq", item.sourceId).value
                    }${index == lineList.length - 1 ? "" : ","}`;
                }, "");
                if (actionFrntSeq) {
                    this.getConfItem("actionFrntSeq", data.actionId).value =
                        actionFrntSeq;
                }

                const _lineList = this.lineList.filter(
                    (line) =>
                        line.sourceId == data.actionId &&
                        this.getConfItem("actionSeq", line.targetId).value
                );
                const actionPostSeq = _lineList.reduce((prev, item, index) => {
                    return `${prev}${
                        this.getConfItem("actionSeq", item.targetId).value
                    }${index == _lineList.length - 1 ? "" : ","}`;
                }, "");
                if (actionPostSeq) {
                    this.getConfItem("actionPostSeq", data.actionId).value =
                        actionPostSeq;
                }
            });
        },
        ...
        getNextSettingItem(sourceItem) {
            console.log("🚀 ~ getNextSettingItem ~ sourceItem:", sourceItem)
            const targetId = this.lineList.find((line) => {
                const targetItem = this.dataList.find(
                    (data) => data.actionId == line.targetId
                );
                return (
                    line.sourceId == sourceItem.actionId &&
                    targetItem.actionType != "throwExceptionAction"
                );
            })?.targetId;
        ...
        isSbsectActionOperateDisabled(type, item) {
            if (type == "split") {
                const merge = item.conf.find(
                    (config) => config.name == "merge"
                ).value;
                return JSON.parse(merge).length <= 1;
            } else if (type == "save") {
                const entityCode = item.conf.find(
                    (config) => config.name == "entityCode"
                ).value;
                const entityName = item.conf.find(
                    (config) => config.name == "entityName"
                ).value;
                return !entityCode || !entityName;
            } else if (type == "merge") {
                return this.dataList.some((data) => {
                    const entityCode = data.conf.find(
                        (config) => config.name == "entityCode"
                    ).value;
                    const entityName = data.conf.find(
                        (config) => config.name == "entityName"
                    ).value;
                    return !entityCode || !entityName;
                });
        ...
        isShowSbsectActionTag(item) {
            return (
                item.conf.find((config) => config.name == "status")?.value == 1
            );
        },
        // 删除字段
        deleteField(item, field) {
            ...
            fieldList = fieldList.filter(
                (data) => data.dictryNo != field.dictryNo
            );
            item.conf.find((config) => config.name == "fieldList").value =
                JSON.stringify(fieldList);
            this.lineList = this.lineList.filter(
                (line) => line.sourceId != field.actionId
            );
        },
        ...
        addItemToContainer(item, containerId) {
            ...
            const container = this.dataList.find(
                (item) => item.actionId == containerId
            );
        ...
        setContainerInnerItemPosition(container, subcomponent) {
            ...
            for (let i in subcomponent) {
                const item = this.dataList.find(
                    (data) => data.actionId == subcomponent[i]
                );
                item.actionX =
                    container.actionX + (this.getItemWidth(item) + 20) * i + 20;
        ...
        moveOutFromContainer() {
            ...
            const _subcomponent = JSON.parse(_conf.value || "[]").filter(
                (item) => item != this.itemObj.actionId
            );
        ...
        oneKeyAlign() {
            ...
            // 根据连线起来的组件的位置序号排序
            dataList.sort((a, b) => {
                const actionSeqA = this.getConfItem(
                    "actionSeq",
                    a.actionId
                ).value;
                const actionSeqB = this.getConfItem(
                    "actionSeq",
                    b.actionId
                ).value;
            ...
            const position = dataList.reduce(
                (prev, data) => {
            ...
            const compensationX = dataList.some((data) =>
                this.containerTypeList.includes(data.actionType)
            )
                ? 10
                : 0;
            const middleX =
                (position.left + position.right) / 2 + compensationX;
            dataList.reduce(
                (prev, item, index) => {
                    if (this.subcomponentIdList.includes(item.actionId))
                        return prev;
                    if (
                        ...
                        const offetX =
                            (this.getItemWidth(item) -
                                prev[prev.length - 1].width) /
                            2;
                        item.actionX = middleX - offetX;
                        item.actionY =
                            prev[prev.length - 1].actionY +
                            prev[prev.length - 1].height +
                            20;
                        // 调整容器内子组件的位置
                        const conf = this.getConfItem(
                            "subcomponent",
        ...
        expandCanvasSize() {
            // 判断X、Y坐标最大的组件是否超出画布范围
            const coordinatesObj = this.dataList.reduce(
                (prev, item) => {
                    const downCircleX = this.getDownCircleX(item);
                    const downCircleY = this.getDownCircleY(item);
                    if (downCircleX > prev.maxX) prev.maxX = downCircleX;
                    if (downCircleY > prev.maxY) prev.maxY = downCircleY;
                    return prev;
                },
                {
                    maxX: 0,
            ...
            if (coordinatesObj?.maxX > this.svgOptions.width) {
                const differenceWidth =
                    coordinatesObj.maxX - this.svgOptions.width;
                this.svgOptions.width += differenceWidth + 100;
            }
            if (coordinatesObj?.maxY > this.svgOptions.height) {
                const differenceHeight =
                    coordinatesObj.maxY - this.svgOptions.height;
                this.svgOptions.height += differenceHeight + 100;
            }
        },
    },
    watch: {
        dataObj(n, o) {
            console.log("?????data=====>22222", n);
            
            this.mapData(n.flow, escape2Html(n.position));
        },
        process_type: {
            handler() {
                this.mapData(this.dataObj.flow, escape2Html(this.dataObj.position))
            },
            immediate: true
        },
        swimlaneInfo: {
            handler(n, o) {
                ...
                this.svgOptions.height =
                    n.height || processConf.svgOptions.height;
            },
            deep: true,
        },
        layoutActionList: {
