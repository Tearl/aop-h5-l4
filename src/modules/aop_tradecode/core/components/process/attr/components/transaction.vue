              ...
              <div class="icon">
                <span
                  ...
                  :class="{
                    ...
                    origin: item.actionType == 'D5SelfAction',
                    blue: ['inputAction', 'outputAction', 'loopAction', 'containerAction', 'cacheSessionAction', 'getSessionAction', 'createGraphValidateCodeAction', 'verifyGraphValidateCodeAction', 'getCacheAction', 'setCacheAction', 'updateCacheAction', 'updateSessionAction', 'setHeaderAction',].includes(item.actionType),
                    green: ['concurrentAction'].includes(item.actionType),
                    purple: ['asyncAction'].includes(item.actionType),
                    grey: true,
                    red: ['throwExceptionAction'].includes(item.actionType),
                  }"
                ></span>
              </div>
