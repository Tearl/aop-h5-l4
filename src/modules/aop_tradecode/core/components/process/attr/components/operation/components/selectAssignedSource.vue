<template>
  <div class="aop_tradecode_comps_design_attr_select_assigned_source">
    <PageDialog
      :dialogTitle="'选择参数'"
...
export default {
  ...
  computed: {
    ...
    assignedSourceKeyOptions() {
      ...
      if ((item || compositeId == this.currentServObj?.svcId) && key) {
...
.aop_tradecode_comps_design_attr_select_assigned_source {
  .container {
    padding: 16px;
  }
  .edit_form {
