...
export default {
  ...
  methods: {
    ...
    initData(item) {
      console.log(item.serviceId, this.currentObj.svcId, 'item.serviceId, this.currentObj.svcId')
    ...
    async saveParams() {
      ...
      const layoutServiceBeanList = {
        ...
        actionTyp: actionTypToArrangeEnum['getDesensitizationAction'],
        loSeqNo: "",
        frntLoSeqNo: "",
        postLoSeqNo: "",
