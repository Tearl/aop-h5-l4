<template>
  <div class="aop_tradecode_comps_design_attr_concurrent_attr">
    <div class="attr_main">
  ...
  methods: {
    async getParams(e, obj) {
      ...
      if (!e.compositeId) {
        ...
        // );
        console.log("inputParamsListAtSetting", e.paramList);
      }
...
.aop_tradecode_comps_design_attr_concurrent_attr {
  position: relative;
  height: 100%;
  .attr_main {
    height: 100%;
