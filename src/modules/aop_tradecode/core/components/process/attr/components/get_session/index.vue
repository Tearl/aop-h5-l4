<template>
  <div class="aop_tradecode_comps_design_attr_get_sessionn_attr">
    <div class="attr_main">
    ...
    async getParams(e, obj) {
      ...
      if (!e.compositeId) {
        ...
        if (e.paramList.length) {
          ...
          // const resQuerySessionParam = await this.rpc.d4.querySessionParam({
          //   cstNo: this.currentServObj.competitorId || this.competitorId,
          //   bizDomainNo: this.currentServObj.bizLineId || this.currentServObj.beltLine,
          //   // appId: this.currentServObj.relySys || this.appId,
          //   appId: this.appId || this.currentServObj.relySys,
          // });
          // this.tableData = reList(resQuerySessionParam.paramList);
          const resQuerySessionParam = await this.rpc.newEditor.querySessionParam({
            // cstNo: this.currentServObj.competitorId || this.competitorId,
            // bizDomainNo: this.currentServObj.bizLineId || this.currentServObj.beltLine,
            // // appId: this.currentServObj.relySys || this.appId,
...
.aop_tradecode_comps_design_attr_get_sessionn_attr {
  position: relative;
  height: 100%;
  .mt10 {
    margin-top: 10px;
