    ...
    <div class="attr_main">
      ...
      <div v-if="!isRead" class="attr_box">
        <div class="attr_show">
          ...
          <div class="attr_show_item">
            <div class="attr_show_item_t"><span>*</span>交易类型：</div>
            <div class="attr_show_item_c">
              <!-- 01-批量转账查询，02-企业内转账查询，03-单笔转账查询 -->
              <el-radio-group v-model="formData.transferState" :disabled="!canSave">
                <el-radio :label="'01'" :disabled="!canSave">批量转账查询</el-radio>
                <el-radio :label="'02'" :disabled="!canSave">企业内转账查询</el-radio>
                <el-radio :label="'03'" :disabled="!canSave">单笔转账查询</el-radio>
              </el-radio-group>
            </div>
          </div>
      ...
      <div v-else class="attr_box">
        <div class="attr_show">
          ...
          <div class="attr_show_item">
            <div class="attr_show_item_t">交易类型：</div>
            <div class="attr_show_item_c">
              <!-- 01-批量转账查询，02-企业内转账查询，03-单笔转账查询 -->
              <el-radio-group v-model="formData.transferState" :disabled="true">
                <el-radio :label="'01'" :disabled="true">批量转账查询</el-radio>
                <el-radio :label="'02'" :disabled="true">企业内转账查询</el-radio>
                <el-radio :label="'03'" :disabled="true">单笔转账查询</el-radio>
              </el-radio-group>
            </div>
          </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async saveParams() {
      ...
      if (!this.formData.transferState) {
        return this.$message.error("交易类型不能为空")
      }
      ...
      confList.map((item) => {
        item.compositeId = this.currentObj.compositeId
        return item
      })
      ...
      console.log(this.currentObj, e, "eeeeee")
