      ...
      <div v-if="!isRead" class="attr_box">
        <div class="attr_show">
          ...
          <div class="attr_show_item attr_show_item_flex">
            <div class="attr_show_item_t required " style="width: 90px;">
              时间格式：
            </div>
            <div class="attr_show_item_c left">
              <el-select style="min-width: 200px;" size="mini" v-model="formData.dateType" placeholder="请选择">
                <el-option
        ...
        <div class="attr_show">
          ...
          <div class="attr_show_item ">
            ...
            <div class="attr_show_item_c left" style="margin-top: 5px;">
              <el-select v-model="formData.dateType" placeholder="请选择" :disabled="true">
                <el-option
                  v-for="item in options"
                  :key="item.value"
                  :label="item.label"
  ...
  methods: {
    ...
    async saveParams() {
      ...
      if (!this.formData.dateType) {
        return this.$message.error("请选择时间格式")
      }
