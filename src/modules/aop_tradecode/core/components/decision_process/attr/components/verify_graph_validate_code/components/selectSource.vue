<template>
  <div class="aop_tradecode_comps_design_attr_create_graph_validate_code_attr_select_source">
    <PageDialog
      :dialogTitle="'选择参数'"
...
.aop_tradecode_comps_design_attr_create_graph_validate_code_attr_select_source {
  .container {
    padding: 16px;
  }
  .edit_form {
