    ...
    <div class="attr_main">
      ...
      <div v-if="!isRead && !fourRAttrFlag" class="attr_box">
        <div class="attr_show">
          ...
          <div class="attr_show_item border_bottom pb20">
            ...
            <div class="attr_show_item_c">
              <el-input :disabled="!canSave" v-model="formData.timeOut" size="mini"></el-input>
            </div>
          </div> -->
        </div>
        <div class="transition_arrange">
          <div class="attr_show">
            <div class="attr_pre_title mb0">
              <div class="attr_pre_title_b bold">会话数据结构</div>
            </div>
          </div>
      ...
      <div v-else class="attr_box">
        <div class="attr_show read">
          ...
          <div class="attr_show_item">
            <div class="attr_show_item_t textLeft">
              缓存时长(秒)：<span class="attr_show_item_i">{{
                formData.timeOut
              }}</span>
            </div>
          </div> -->
...
export default {
  ...
  methods: {
    async getParams(e, obj) {
      ...
      if (!e.compositeId) {
        ...
        if (res.paramList.length) {
          ...
          const resQuerySessionParam = await this.rpc.transactionDesign.querySessionParam({
    ...
    // /aop_tradecode/s4Design/design?viewType=func&isolateWorkspace=T2&admiId=&modelVersion=C1-0016362&modelName=新增首页A&competitorId=10000000&jobId=100001&bizLineId=FM-YWY-2022-000001&appId=A2-YWYY-016221&authId=FM1-AFJI-20231229-00016331&asgntNo=C1-0016362&assetFnctNo=A2-GN-2023-000012624&authAstFnctInfoId=FM1-AAJI-20231229-00052062&fnctNo=FM-ZC-2023-017023&projectId=A2-APP-2023122800018360&authFnctJobInfoId=FM1-AFJI-20231229-00016331&pageMode=s4design
