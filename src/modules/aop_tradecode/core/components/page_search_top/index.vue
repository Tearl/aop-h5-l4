<template>
  <div class="aop_tradecode_comps_page_service_top">
          ...
          >
            ...
            >
              ...
              <el-select
                ...
                :placeholder="item.placeholder"
                clearable
                @change="(e) => selectChange(e, item.model)"
              >
                <el-option
              ...
              <div v-else-if="item.type == 'radioGroup'">
                <el-radio-group v-model="form[item.model]" size="small">
                  <el-radio v-for="i in item.groupItem" :key="i.label" :label="i.label">{{ i.content }}</el-radio>
                </el-radio-group>
              </div>
            </el-form-item>
          </el-form>
