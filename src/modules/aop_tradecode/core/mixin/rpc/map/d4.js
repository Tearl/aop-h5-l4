...
export default {
   ...
   //AOP030026
   getD4bServiceInfo: proxy("devopsEditor/queryD4bInfo"), // D4b服务详情查询
   queryD4bInfoAndParamDetaill: proxy("devopsEditor/queryD4bInfoAndParamDetaill"), // D4服务详情查询
   ...
   queryS5SvcPageList: proxy("ownBindRulesServiceI/queryS5SvcPageList"), // D4b服务列表=需求下、功能下
   //AOP030044
   ...
   //AOP030050
   saveServiceCpnParams: proxy("devopsEditor/addOrUpdateProcessCompositeInfo",), // 组件配置信息保存
   //AOP030051
   getServiceCpnParams: proxy("devopsEditor/queryProcessCompositeInfo",), // 服务组件参数查询
   queryL5ParamAndRuleDefinitions: proxy("devopsEditor/queryL5ParamAndRuleDefinitions",), // 服务组件参数查询
   ...
   //AOP030147
   getFlowdata: proxy("devopsEditor/query4RFlow"), //获取流程图flow信息
   toSave4RAction: proxy("AOP030148"), //保存4R子流程图

   //AOP030052
   saveAction: proxy("devopsEditor/updateDataViewParam"), //保存组件后再存储一次
   ...
   //AOP070206
   getFuncServList: proxy("devopsEditor/queryListBottomApi"), //查询功能下的所有服务列表
   ...
   //AOP03203
   getAssociatedSelfServiceList: proxy("devopsEditor/queryD4UseL5SvcPage"), //后端设计-已关联的自有服务列表
   ...
   saveD4bTranDesignFlow: proxy("devopsEditor/saveD4bTranDesignFlow"), //保存流程图及编排流程
   generateCompositeId: proxy("devopsEditor/generateCompositeId "), //生成组件id
   updateD4Param: proxy("devopsEditor/updateD4Param "), //设置交易的输出参数

   getElementList: proxy("AOP020014"), //查询要素列表
   getElementServList: proxy("AOP020019"), //查询要素下服务列表

   //MK001042
   getL5ServField: proxy("devopsEditor/queryApiBodyParamPage"), //查询L5服务下字段

   //AOP03201
   addDownLoadTrans: proxy("devopsEditor/addFnctD4Svc"), //新增交易
   getDownLoadTransList: proxy("AOP03202"), //查询交易列表
   //AOP03204
   delDownLoadTrans: proxy("devopsEditor/deleteFnctSvc"), //删除交易
   ...
   querySessionParam: proxy("devopsEditor/querySessionParam"), //查询会话的接口
   //新版交易列表有是否校验
   getNewRelationServList: proxy("devopsEditor/queryBindServiceList"), //查询已关联交易列表
   ...
   queryCompositeTypeList: proxy('devopsEditor/queryCompositeTypeList'),
   getDemandInfoList: proxy('L5/demandInfoServiceI/getDemandInfoList'), //获取功能需求列表
   queryServiceByFuncId: proxy('L5/ownBindRulesController/queryServiceByFuncId'),//查询规则服务列表
   delDemandInfo: proxy('L5/demandInfoServiceI/delDemandInfo'),//删除4b需求设计
   saveOrUpDemandInfo: proxy('L5/demandInfoServiceI/saveOrUpDemandInfo'),//新增4b需求设计
   queryInterfaceProcessActionLayoutRel: proxy("processLayoutServiceI/queryInterfaceProcessActionLayoutRel"), //查询接口流程组件编排关系
   commitSameStartActionLayoutRel: proxy("processLayoutServiceI/commitSameStartActionLayoutRel"), //保存相同起点组件的编排关系
   addOrUpdateInterfaceProcessActionLayoutRel: proxy("processLayoutServiceI/addOrUpdateInterfaceProcessActionLayoutRel"), //新增或修改接口流程组件编排关系
   removeInterfaceProcessActionLayoutRel: proxy("processLayoutServiceI/removeInterfaceProcessActionLayoutRel"), //删除接口流程组件编排关系
   queryErrorMessageClassList: proxy("errorMessageManageServiceI/queryErrorMessageClassList"),
   queryErrorMessagePageList: proxy("errorMessageManageServiceI/queryErrorMessagePageList"),
   querySameStartActionLayoutRel: proxy("processLayoutServiceI/querySameStartActionLayoutRel"), //查询相同起点组件编排关系
   queryErrorMessageList: proxy("errorMessageManageServiceI/queryErrorMessageList"),
   queryInterfaceProcessLayoutInfo: proxy("processLayoutServiceI/queryInterfaceProcessLayoutInfo"), //查询接口流程编排信息
   queryWaitUseServiceList: proxy("processLayoutServiceI/queryWaitUseServiceList"),
   commitInterfaceProcessLayoutInfo: proxy("processLayoutServiceI/commitInterfaceProcessLayoutInfo"),
   queryEnumClassPageList: proxy("enumManageServiceI/queryEnumClassPageList"),
   queryEnumClassInfo: proxy("enumManageServiceI/queryEnumClassInfo"), //查询枚举类详情
   ...
   paramStandardDetection: proxy("finaBranchDataDictionaryService/paramStandardDetection"), //参数标化检测
   ...
   AddParamMapping: proxy("finaBranchDataDictionaryService/AddParamMapping"),
   ...
   s4ParamStandardDetection: proxy("finaBranchDataDictionaryService/s4ParamStandardDetection"), // S4参数标化检测
   s5ParamStandardDetection: proxy("finaBranchDataDictionaryService/s5ParamStandardDetection"), // S5参数标化检测
   dataDictionaryFieldAddApply: proxy("dataDictionaryService/dataDictionaryFieldAddApply"), // 数据字典项申请添加
   qryDataDictionaryBaseDataTypeList: proxy("dataDictionaryService/qryDataDictionaryBaseDataTypeList"), // 数据字典基础数据类型列表
   getAssociatedSelfServiceList: proxy("standardData/queryS5InfoListByS4Id"), //后端设计-已关联的自有服务列表
}
