  ...
  <div class="aop_tradecode_page_d4workbench_workbench_service_design">
    ...
    <AsNav @navBack="navBack" :asideActive="asideActive">
      ...
      <div slot="btnProps">
        ...
        >
        <el-button
          v-if="pageMode != 'read' && picDefault == '4bFlow'"
          :disabled="saveDisabled || showSrcFnctFlg"
          type="primary"
          @click="toSave"
          ...
          <div class="process_container">
            ...
            <div class="process_middle">
              <div class="flow_aside">
                ...
                <!-- <div class="left_process" @click.stop="picClick('mainFlow')" :class="{ active: picDefault == 'mainFlow' }">主流程</div>
              <div class="left_process" @click.stop="picClick('4bFlow')"  :class="{ active: picDefault == '4bFlow' }">4b流程</div> -->
              </div>
              <!-- <div class="flowTabs">
                <div
                  class="left_process"
