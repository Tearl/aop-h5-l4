    ...
    <div class="dialog-content-table">
        ...
        >
            ...
            <div class="dialogTable">
                <span style="font-size:16px;line-height:32px;">功能信息</span>
                <el-table
                    :data="tranData"
                    align="center"
                    :header-cell-style="{
            ...
            <div class="dialogTable">
                ...
                >
                    ...
                    >
                        ...
                        <template slot-scope="scope">
                            <el-checkbox :data-a="responsive"
                                v-model="scope.row.status"
                                :disabled="scope.row.type=='功能' || scope.row.srcFnctFlg == '0'"
...
export default {
    ...
    watch: {
            ...
            handler(newVal, oldVal) {
                if(newVal){
                    ...
                    this.tableData.forEach((item)=>{
                        ...
                        //     item.status= true
                        // }
                        //srcFnctFlg为1是接口添加的，srcFnctFlg为0是选进来
        ...
        "tableData": {
            handler(newVal, oldVal) {
                ...
                let tempArr = list.filter(item => item.srcFnctFlg == "1")
    ...
    methods: {
        ...
        async appyBranchCodeSave(obj) {
            ...
            this.$emit('updateCreateCode', list)
            // const params = {
            //     authFnctJobInfoId: this.authFnctJobInfoId2,
