<template>
  <div style="width: 100%; height: calc(100vh - 48px);" ref="editor"></div>
</template>
...
export default {
  ...
  created() {
    // CDN引入（链接源自官方demo）
    let src =
       window.origin + "/package/monaco-editor/0.33.0/min/vs/loader.js";
    // public 引入
  ...
  methods: {
    ...
    loader(loading) {
      ...
      // CDN引入（链接源自官方demo）
      let vsPath =
        window.origin + "/package/monaco-editor/0.33.0/min/vs";
      // public 引入
