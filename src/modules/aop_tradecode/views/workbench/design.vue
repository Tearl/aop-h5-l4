<template>
  <div class="aop_tradecode_page_d4workbench_workbench_design">
    <!-- 服务定义 -->
    <ServiceDefine
...
import ServiceDefine from "./components/design_editor/service_define";
import Code from "./components/design_editor/code";
