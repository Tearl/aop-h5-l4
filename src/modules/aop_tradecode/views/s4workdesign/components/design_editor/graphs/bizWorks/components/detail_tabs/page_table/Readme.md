...
- type:         显示类型 input,select,text,enum,switch, button, checkbox(有true与false两个属性对应true-label，false-label), textClick(文字可点击触发事件,有默认样式),textClassList(通过表格的属性值判断文字样式),radio
