<template>
  <div class="aop_tradecode_comps_d4editor_service_define_base_info">
    <!-- <PageHeader
    ...
    >
      <div slot="rightNav" class="rightNav">
        <PageRightNav
          :itemList="itemList"
...
.aop_tradecode_comps_d4editor_service_define_base_info {
