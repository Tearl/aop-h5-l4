  ...
  <div class="aop_tradecode_comps_trans_detail_info">
      ...
      <div class="detail_list_left">
        <div class="left_content trans_content">
          ...
          <el-tooltip
            class="item"
            effect="dark"
            :content="detailInfo.apiName"
            placement="top"
          >
            <span class="trans_nm">
              <span class="content_info">{{ detailInfo.apiName }}</span>
            </span>
          </el-tooltip>
        </div>
        ...
        <div class="left_content">
          <span>归属业务域：</span>
          <span class="content_info">{{ detailInfo.beltLine }}</span>
        </div>
      </div>
      <div class="detail_list_right">
        <div class="right_content">
          <span>规则类型：</span>
          <span class="content_info">{{ detailInfo.apiServiceTypeNm }}</span>
        </div>
        <div class="right_content">
          <span>创建人：</span>
    ...
    <div class="detail_list_bottom">
      <div class="bottom_content">
        <span>规则描述：</span>
        <span class="content_info">{{ detailInfo.apiDesc }}</span>
      </div>
    </div>
  </div>
</template>
