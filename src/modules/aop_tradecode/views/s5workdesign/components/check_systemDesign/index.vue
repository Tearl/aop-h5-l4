          ...
          <ul class="standar_check_list">
            <li v-for="(item, index) in standardCheckData" :key="index" class="list_item">
              ...
              <div class="right">
                ...
                <el-button type="primary" size="mini" :disabled="item.checkFlg != '1'"
  ...
  methods: {
    ...
    async showStandardCheckDialog(data) {
      console.log("daraaa", data);
       setTimeout(() => {
        // 业务规则是否充分实现
        this.standardCheckData[0].checkFlg = data.bizRuleFullAchCheckReltCd;
        this.arrangeParamList = data.unFullAchBizRuleList;
        console.log(this.arrangeParamList)
        this.checkEnd = true
